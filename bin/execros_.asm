...
0018	0126		OR R1, R2
001A	C103		SZ R1
001C	F009		BRA $0014		; -> -$0A(R0)

001E	8F1F		LBI R15, #$1F
0020	0FFD		MLH R15, R15
0022	8FFF		LBI R15, #$FF
0024	61F8		MOVB R1, (R15)
0026	C10C		SNS R1
0028	A00D		BRA $0038		; $0E(R0)
...
0032	81FF		LBI R1, #$FF
0034	C517		SBSH R5, R1
0036	F013		BRA $0024		; -> -$14(R0)
...
004E	8E80		LBI R14, #$80
0050	8DC0		LBI R13, #$C0
0052	0F34		MOVE R15, R3
...
0062	351F		MOVE $3E, R5
0064	8502		LBI R5, #$02
0066	055D		MLH R5, R5
0068	8500		LBI R5, #$00
006A	351E		MOVE $3C, R5
006C	8F40		LBI R15, #$40
...
00AA	8BC3		LBI R11, #$C3
00AC	7B42		MOVB (R4)+++, R11
00AE	341B		MOVE $36, R4
00B0	8100		LBI R1, #$00
00B2	011D		MLH R1, R1
00B4	0310		DEC2 R3, R1
00B6	E03D		ROR R3
00B8	A382		ADD R3, #$83
00BA	7331		MOVB (R3)++, R3
00BC	0211		DEC R2, R1
00BE	6433		MOVB R4, (R3)++++
00C0	E04D		ROR R4
00C2	0436		OR R4, R3
00C4	D533		MOVE R5, (R3)++
00C6	F57F		SUB R5, #$80
00C8	5534		MOVE (R3)~, R5
00CA	0563		INC2 R5, R6
00CC	6736		MOVB R7, (R3)---
00CE	D837		MOVE R8, (R3)--
00D0	5838		MOVE (R3), R8
00D2	0277		XOR R2, R7
00D4	D938		MOVE R9, (R3)
00D6	B707		SET R7, #$07
00D8	0738		ADD R7, R3
00DA	6A78		MOVB R10, (R7)
00DC	E05F		SWAP R5
00DE	0A59		SUB R10, R5
00E0	5A38		MOVE (R3), R10
00E2	02AA		ADDH R2, R10
00E4	E02E		ROR3 R2
00E6	D938		MOVE R9, (R3)
00E8	E09C		SHR R9
00EA	099B		ADDH2 R9, R9
00EC	6B78		MOVB R11, (R7)
00EE	089C		MHL R8, R9
00F0	985A		CLR R8, #$5A
00F2	0B85		AND R11, R8
00F4	E0BC		SHR R11
00F6	330C		MOVE $18, R3
00F8	FC02		SUB R12, #$03
00FA	2D07		MOVE R13, $0E
00FC	0ED4		MOVE R14, R13
00FE	0EC8		ADD R14, R12
0100	0EB8		ADD R14, R11
0102	0F04		MOVE R15, R0
0104	8F56		LBI R15, #$56
...
0320	8BD9		LBI R11, #$D9
0322	7B40		MOVB (R4)+, R11
0324	8BD6		LBI R11, #$D6
0326	7B40		MOVB (R4)+, R11
0328	8BE2		LBI R11, #$E2
...
0338	8E02		LBI R14, #$02
033A	3E80		MOVE $100, R14
033C	8E40		LBI R14, #$40
033E	3E81		MOVE $102, R14
0340	2E56		MOVE R14, $AC
0342	3E82		MOVE $104, R14
0344	8E18		LBI R14, #$18
0346	0EED		MLH R14, R14
0348	8E00		LBI R14, #$00
034A	3E83		MOVE $106, R14
034C	2F50		MOVE R15, $A0
034E	3F84		MOVE $108, R15
0350	3F86		MOVE $10C, R15
0352	8640		LBI R6, #$40
0354	361C		MOVE $38, R6
0356	0EF1		DEC R14, R15
0358	8F1C		LBI R15, #$1C
035A	1102		CTRL $1, #$02
035C	41F8		PUTB $1, (R15)
035E	41F8		PUTB $1, (R15)
0360	E1DF		STAT R13, $1
0362	E1CF		STAT R12, $1
0364	CD0C		SNS R13
0366	CC04		SS R12
0368	A011		BRA $037C		; $12(R0)

036A	011E		GETB R1, $1
036C	F000		BRA $036D		; -> -$01(R0)

036E	011E		GETB R1, $1
0370	E1DF		STAT R13, $1
0372	E1CF		STAT R12, $1
0374	CD0B		SNZ R13
0376	CC03		SZ R12
0378	A001		BRA $037C		; $02(R0)

037A	A009		BRA $0386		; $0A(R0)

037C	81F0		LBI R1, #$F0
037E	011D		MLH R1, R1
0380	81F1		LBI R1, #$F1
0382	3186		MOVE $10C, R1
0384	A011		BRA $0398		; $12(R0)
...
0398	2686		MOVE R6, $10C
039A	C60B		SNZ R6
039C	A023		BRA $03C2		; $24(R0)

039E	241B		MOVE R4, $36
03A0	A403		ADD R4, #$04
03A2	8BC5		LBI R11, #$C5
03A4	7B40		MOVB (R4)+, R11
03A6	8BD9		LBI R11, #$D9
...
03E4	A403		ADD R4, #$04
03E6	8BC9		LBI R11, #$C9
03E8	7B40		MOVB (R4)+, R11
03EA	8BC4		LBI R11, #$C4
...
045A	8142		LBI R1, #$42
045C	C612		SE R6, R1
045E	A01D		BRA $047E		; $1E(R0)

0460	8610		LBI R6, #$10
0462	8F08		LBI R15, #$08
0464	2E52		MOVE R14, $A4
0466	8104		LBI R1, #$04
0468	CE17		SBSH R14, R1
046A	A003		BRA $0470		; $04(R0)

046C	8620		LBI R6, #$20
046E	8F04		LBI R15, #$04
0470	3F80		MOVE $100, R15
0472	2F50		MOVE R15, $A0
0474	3F84		MOVE $108, R15
0476	8E18		LBI R14, #$18
0478	0EED		MLH R14, R14
047A	8E00		LBI R14, #$00
047C	3E83		MOVE $106, R14
047E	8103		LBI R1, #$03
0480	011D		MLH R1, R1
0482	8186		LBI R1, #$86
0484	0014		RET R1
...
04A0	251E		MOVE R5, $3C
04A2	8BD8		LBI R11, #$D8
...
04C6	0CCD		MLH R12, R12
04C8	0AC5		AND R10, R12
04CA	0EC4		MOVE R14, R12
...
0584	1102		CTRL $1, #$02
0586	8D7C		LBI R13, #$7C
0588	41D0		PUTB $1, (R13)+
058A	41D4		PUTB $1, (R13)-
058C	F000		BRA $058D		; -> -$01(R0)
...
05AE	0000		HALT
05B0	2F1E		MOVE R15, $3C
05B2	8F80		LBI R15, #$80
05B4	8BC1		LBI R11, #$C1
05B6	7BF0		MOVB (R15)+, R11
05B8	8BE4		LBI R11, #$E4
05BA	7BF0		MOVB (R15)+, R11
05BC	8BE7		LBI R11, #$E7
05BE	7BF1		MOVB (R15)++, R11
05C0	8BC9		LBI R11, #$C9
05C2	7BF0		MOVB (R15)+, R11
05C4	8BD7		LBI R11, #$D7
05C6	7BF0		MOVB (R15)+, R11
05C8	8BD3		LBI R11, #$D3
...
067E	0000		HALT
0680	1443		CTRL $4, #$43
0682	DE38		MOVE R14, (R3)
0684	0533		INC2 R5, R3
0686	D651		MOVE R6, (R5)+
0688	D451		MOVE R4, (R5)+
068A	8120		LBI R1, #$20
068C	C616		SBC R6, R1
068E	0344		MOVE R3, R4
0690	DC51		MOVE R12, (R5)+
...
06A0	8DF1		LBI R13, #$F1
06A2	0DDD		MLH R13, R13
06A4	8DF4		LBI R13, #$F4
06A6	1108		CTRL $1, #$08
06A8	8108		LBI R1, #$08
06AA	CE1A		SNE R14, R1
06AC	A00F		BRA $06BE		; $10(R0)

06AE	1104		CTRL $1, #$04
06B0	8104		LBI R1, #$04
06B2	CE1A		SNE R14, R1
06B4	A007		BRA $06BE		; $08(R0)

06B6	1102		CTRL $1, #$02
06B8	8102		LBI R1, #$02
06BA	CE12		SE R14, R1
06BC	A03D		BRA $06FC		; $3E(R0)

06BE	4150		PUTB $1, (R5)+
06C0	4154		PUTB $1, (R5)-
06C2	8DF0		LBI R13, #$F0
06C4	0DDD		MLH R13, R13
06C6	8DF2		LBI R13, #$F2
06C8	0F6C		MHL R15, R6
06CA	8101		LBI R1, #$01
06CC	CF12		SE R15, R1
06CE	A035		BRA $0706		; $36(R0)

06D0	2950		MOVE R9, $A0
06D2	8508		LBI R5, #$08
06D4	C655		SBS R6, R5
06D6	0991		DEC R9, R9
...
06DE	7A40		MOVB (R4)+, R10
06E0	AC00		ADD R12, #$01
06E2	0803		INC2 R8, R0
06E4	C655		SBS R6, R5
06E6	A043		BRA $072C		; $44(R0)

06E8	CCBF		SNBSH R12, R11
06EA	F011		BRA $06DA		; -> -$12(R0)

06EC	8120		LBI R1, #$20
06EE	C616		SBC R6, R1
06F0	F071		BRA $0680		; -> -$72(R0)

06F2	019C		MHL R1, R9
06F4	0196		OR R1, R9
06F6	C10B		SNZ R1
06F8	A007		BRA $0702		; $08(R0)

06FA	8DF7		LBI R13, #$F7
...
0802	011D		MLH R1, R1
0804	814A		LBI R1, #$4A
0806	317E		MOVE $FC, R1
0808	2450		MOVE R4, $A0
080A	0303		INC2 R3, R0
080C	A001		BRA $0810		; $02(R0)
...
0816	8108		LBI R1, #$08
0818	C416		SBC R4, R1
081A	A02B		BRA $0848		; $2C(R0)

081C	216C		MOVE R1, $D8
081E	A111		ADD R1, #$12
0820	D818		MOVE R8, (R1)
0822	018C		MHL R1, R8
0824	C10B		SNZ R1
0826	A011		BRA $083A		; $12(R0)
...
0844	1F04		CTRL $F, #$04
0846	0033		INC2 R0, R3
0848	107D		CTRL $0, #$7D
084A	8440		LBI R4, #$40
084C	E44F		STAT R4, $4
084E	2558		MOVE R5, $B0
...
086A	8106		LBI R1, #$06
086C	C912		SE R9, R1
086E	A02B		BRA $089C		; $2C(R0)

0870	8176		LBI R1, #$76
0872	C410		SLE R4, R1
0874	A007		BRA $087E		; $08(R0)
...
089C	8101		LBI R1, #$01
089E	C716		SBC R7, R1
08A0	A083		BRA $0926		; $84(R0)

08A2	0544		MOVE R5, R4
08A4	058D		MLH R5, R8
08A6	3558		MOVE $B0, R5
08A8	81B6		LBI R1, #$B6
08AA	C912		SE R9, R1
08AC	0034		RET R3
...
0A10	CA03		SZ R10
0A12	F005		BRA $0A0E		; -> -$06(R0)

0A14	0034		RET R3

0A16	1102		CTRL $1, #$02
0A18	2A50		MOVE R10, $A0
0A1A	8A72		LBI R10, #$72
0A1C	41A0		PUTB $1, (R10)+
0A1E	41A4		PUTB $1, (R10)-
0A20	F000		BRA $0A21		; -> -$01(R0)
...
0A5C	8116		LBI R1, #$16
0A5E	C41A		SNE R4, R1
0A60	A017		BRA $0A7A		; $18(R0)

0A62	8101		LBI R1, #$01
0A64	C717		SBSH R7, R1
0A66	A00B		BRA $0A74		; $0C(R0)

0A68	8102		LBI R1, #$02
0A6A	C71F		SNBSH R7, R1
0A6C	A005		BRA $0A74		; $06(R0)
...
0A94	C8A2		SE R8, R10
0A96	F007		BRA $0A90		; -> -$08(R0)

0A98	217E		MOVE R1, $FC
0A9A	3100		MOVE $00, R1
0A9C	8101		LBI R1, #$01
...
0AAA	9C0E		CLR R12, #$0E
0AAC	8110		LBI R1, #$10
0AAE	C716		SBC R7, R1
0AB0	A005		BRA $0AB8		; $06(R0)
...
0B84	011D		MLH R1, R1
0B86	8100		LBI R1, #$00
0B88	317C		MOVE $F8, R1
0B8A	3108		MOVE $10, R1
0B8C	2156		MOVE R1, $AC
0B8E	3100		MOVE $00, R1
0B90	0034		RET R3
...
0C70	89C0		LBI R9, #$C0
0C72	88C0		LBI R8, #$C0
0C74	8AC4		LBI R10, #$C4
0C76	2152		MOVE R1, $A4
0C78	8102		LBI R1, #$02
0C7A	C11F		SNBSH R1, R1
0C7C	8AD4		LBI R10, #$D4
...
0D76	F005		BRA $0D72		; -> -$06(R0)

0D78	8105		LBI R1, #$05
0D7A	011D		MLH R1, R1
0D7C	8100		LBI R1, #$00
0D7E	5138		MOVE (R3), R1
...
0DAE	066D		MLH R6, R6
0DB0	8600		LBI R6, #$00
0DB2	56F1		MOVE (R15)+, R6
0DB4	0164		MOVE R1, R6
0DB6	A169		ADD R1, #$6A
0DB8	51E1		MOVE (R14)+, R1
0DBA	8100		LBI R1, #$00
0DBC	011D		MLH R1, R1
0DBE	8166		LBI R1, #$66
...
0E04	AF0B		ADD R15, #$0C
0E06	81F0		LBI R1, #$F0
0E08	011D		MLH R1, R1
0E0A	81F1		LBI R1, #$F1
0E0C	51F8		MOVE (R15), R1
0E0E	A031		BRA $0E42		; $32(R0)
...
0E1A	9D1F		CLR R13, #$1F
0E1C	AF05		ADD R15, #$06
0E1E	5DF8		MOVE (R15), R13
0E20	A04F		BRA $0E72		; $50(R0)

0E22	836C		LBI R3, #$6C
0E24	0F34		MOVE R15, R3
0E26	AF01		ADD R15, #$02
0E28	2150		MOVE R1, $A0
0E2A	51F8		MOVE (R15), R1
...
0E38	A001		BRA $0E3C		; $02(R0)

0E3A	A005		BRA $0E42		; $06(R0)
...
0E76	D4F8		MOVE R4, (R15)
0E78	0E44		MOVE R14, R4
0E7A	AE1F		ADD R14, #$20
0E7C	5EF3		MOVE (R15)++, R14
0E7E	DCF1		MOVE R12, (R15)+
0E80	DEF8		MOVE R14, (R15)
0E82	836C		LBI R3, #$6C
0E84	CE03		SZ R14
0E86	8380		LBI R3, #$80
0E88	8101		LBI R1, #$01
0E8A	0E17		XOR R14, R1
0E8C	5EF8		MOVE (R15), R14
0E8E	0E34		MOVE R14, R3
0E90	AE03		ADD R14, #$04
0E92	D6E8		MOVE R6, (R14)
0E94	0203		INC2 R2, R0
0E96	A02B		BRA $0EC4		; $2C(R0)
...
0FAE	C51A		SNE R5, R1
0FB0	A900		ADD R9, #$01
0FB2	0803		INC2 R8, R0
0FB4	A021		BRA $0FD8		; $22(R0)

0FB6	A001		BRA $0FBA		; $02(R0)

0FB8	A007		BRA $0FC2		; $08(R0)
...
0FC6	C512		SE R5, R1
0FC8	C50B		SNZ R5
0FCA	A001		BRA $0FCE		; $02(R0)

0FCC	F065		BRA $0F68		; -> -$66(R0)
...
0FD8	1102		CTRL $1, #$02
0FDA	3939		MOVE $72, R9
0FDC	2A50		MOVE R10, $A0
0FDE	8A72		LBI R10, #$72
0FE0	41A0		PUTB $1, (R10)+
0FE2	41A4		PUTB $1, (R10)-
0FE4	F000		BRA $0FE5		; -> -$01(R0)
...
1D5E	81C6		LBI R1, #$C6
1D60	8AC1		LBI R10, #$C1
1D62	C518		SGT R5, R1
1D64	C5A9		SGE R5, R10
1D66	A019		BRA $1D82		; $1A(R0)
...
1E1E	81C5		LBI R1, #$C5
1E20	71E0		MOVB (R14)+, R1
1E22	81D9		LBI R1, #$D9
1E24	011D		MLH R1, R1
1E26	51E1		MOVE (R14)+, R1
1E28	8BD6		LBI R11, #$D6
1E2A	01BD		MLH R1, R11
1E2C	51E2		MOVE (R14)+', R1
1E2E	81F0		LBI R1, #$F0
1E30	71E0		MOVB (R14)+, R1
1E32	0B34		MOVE R11, R3
1E34	AB0B		ADD R11, #$0C
1E36	D1B8		MOVE R1, (R11)
1E38	51E2		MOVE (R14)+', R1
1E3A	D538		MOVE R5, (R3)
1E3C	0403		INC2 R4, R0
1E3E	F0B9		BRA $1D86		; -> -$BA(R0)
...
1FD0	011D		MLH R1, R1
1FD2	8101		LBI R1, #$01
1FD4	31E0		MOVE $1C0, R1
1FD6	8108		LBI R1, #$08
1FD8	011D		MLH R1, R1
1FDA	8100		LBI R1, #$00
1FDC	3130		MOVE $60, R1
1FDE	810D		LBI R1, #$0D
1FE0	011D		MLH R1, R1
1FE2	8100		LBI R1, #$00
1FE4	317F		MOVE $FE, R1
1FE6	810F		LBI R1, #$0F
1FE8	011D		MLH R1, R1
1FEA	8140		LBI R1, #$40
1FEC	3173		MOVE $E6, R1
1FEE	8110		LBI R1, #$10
1FF0	011D		MLH R1, R1
1FF2	8100		LBI R1, #$00
1FF4	317C		MOVE $F8, R1
1FF6	A109		ADD R1, #$0A
1FF8	317D		MOVE $FA, R1
1FFA	0824		MOVE R8, R2
1FFC	2056		JMP ($00AC)

1FFE	F031		BRA $1FCE		; -> -$32(R0)

2000	3269		MOVE $D2, R2
2002	D538		MOVE R5, (R3)
2004	055C		MHL R5, R5
2006	810D		LBI R1, #$0D
2008	C51A		SNE R5, R1
200A	A003		BRA $2010		; $04(R0)

200C	865E		LBI R6, #$5E
200E	A065		BRA $2076		; $66(R0)
...
2018	A01D		BRA $2038		; $1E(R0)

201A	D538		MOVE R5, (R3)
201C	810F		LBI R1, #$0F
201E	C516		SBC R5, R1
2020	F015		BRA $200C		; -> -$16(R0)

2022	0433		INC2 R4, R3
2024	6548		MOVB R5, (R4)
2026	C503		SZ R5
2028	A00F		BRA $203A		; $10(R0)

202A	A40D		ADD R4, #$0E
202C	2750		MOVE R7, $A0
202E	8704		LBI R7, #$04
2030	5748		MOVE (R4), R7
2032	2862		MOVE R8, $C4
2034	0203		INC2 R2, R0
2036	2056		JMP ($00AC)

2038	A0E9		BRA $2124		; $EA(R0)
...
2058	8108		LBI R1, #$08
205A	C515		SBS R5, R1
205C	A003		BRA $2062		; $04(R0)

205E	861E		LBI R6, #$1E
2060	A013		BRA $2076		; $14(R0)

2062	1D01		CTRL $D, #$01
2064	0433		INC2 R4, R3
2066	6548		MOVB R5, (R4)
2068	C50B		SNZ R5
206A	A0BD		BRA $212A		; $BE(R0)

206C	0D7E		GETB R7, $D
206E	8180		LBI R1, #$80
2070	C715		SBS R7, R1
2072	A00B		BRA $2080		; $0C(R0)
...
209C	D748		MOVE R7, (R4)
209E	8101		LBI R1, #$01
20A0	C716		SBC R7, R1
20A2	A033		BRA $20D8		; $34(R0)

20A4	A407		ADD R4, #$08
20A6	D448		MOVE R4, (R4)
20A8	A408		ADD R4, #$09
...
20B0	8103		LBI R1, #$03
20B2	C51A		SNE R5, R1
20B4	A02B		BRA $20E2		; $2C(R0)

20B6	8108		LBI R1, #$08
20B8	C51A		SNE R5, R1
20BA	A01F		BRA $20DC		; $20(R0)

20BC	810B		LBI R1, #$0B
20BE	C512		SE R5, R1
20C0	A007		BRA $20CA		; $08(R0)
...
20D8	8101		LBI R1, #$01
20DA	C51A		SNE R5, R1
20DC	A0DB		BRA $21BA		; $DC(R0)

20DE	8102		LBI R1, #$02
20E0	C51A		SNE R5, R1
20E2	A0D3		BRA $21B8		; $D4(R0)

20E4	8110		LBI R1, #$10
20E6	C512		SE R5, R1
20E8	A017		BRA $2102		; $18(R0)
...
20FE	1D01		CTRL $D, #$01
2100	A015		BRA $2118		; $16(R0)

2102	8111		LBI R1, #$11
2104	C512		SE R5, R1
2106	A00B		BRA $2114		; $0C(R0)
...
2112	A003		BRA $2118		; $04(R0)

2114	865E		LBI R6, #$5E
2116	F0A1		BRA $2076		; -> -$A2(R0)
...
2172	354D		MOVE $9A, R5
2174	354E		MOVE $9C, R5
2176	8507		LBI R5, #$07
2178	354F		MOVE $9E, R5
217A	85D0		LBI R5, #$D0
217C	354C		MOVE $98, R5
217E	8134		LBI R1, #$34
2180	011D		MLH R1, R1
2182	8138		LBI R1, #$38
...
2188	C60B		SNZ R6
218A	A003		BRA $2190		; $04(R0)

218C	8632		LBI R6, #$32
218E	A0A7		BRA $2238		; $A8(R0)
...
21A8	870A		LBI R7, #$0A
21AA	5748		MOVE (R4), R7
21AC	A407		ADD R4, #$08
21AE	87F1		LBI R7, #$F1
21B0	077D		MLH R7, R7
21B2	87C4		LBI R7, #$C4
21B4	5748		MOVE (R4), R7
21B6	F09F		BRA $2118		; -> -$A0(R0)
...
21DC	5548		MOVE (R4), R5
21DE	F409		SUB R4, #$0A
21E0	D548		MOVE R5, (R4)
21E2	352E		MOVE $5C, R5
21E4	8133		LBI R1, #$33
21E6	011D		MLH R1, R1
21E8	8136		LBI R1, #$36
...
2208	C603		SZ R6
220A	A01B		BRA $2228		; $1C(R0)

220C	0434		MOVE R4, R3
220E	A40D		ADD R4, #$0E
2210	D548		MOVE R5, (R4)
2212	A500		ADD R5, #$01
2214	5548		MOVE (R4), R5
2216	8136		LBI R1, #$36
2218	011D		MLH R1, R1
221A	81F8		LBI R1, #$F8
...
222A	81C6		LBI R1, #$C6
222C	C51A		SNE R5, R1
222E	A011		BRA $2242		; $12(R0)

2230	81C4		LBI R1, #$C4
2232	C51A		SNE R5, R1
2234	A00B		BRA $2242		; $0C(R0)
...
2258	2522		MOVE R5, $44
225A	015C		MHL R1, R5
225C	0516		OR R5, R1
225E	C503		SZ R5
2260	F07D		BRA $21E4		; -> -$7E(R0)

2262	F0AD		BRA $21B6		; -> -$AE(R0)
...
2278	C60B		SNZ R6
227A	F0C5		BRA $21B6		; -> -$C6(R0)

227C	860A		LBI R6, #$0A
227E	F047		BRA $2238		; -> -$48(R0)
...
2326	8106		LBI R1, #$06
2328	C515		SBS R5, R1
232A	A003		BRA $2330		; $04(R0)

232C	865E		LBI R6, #$5E
232E	A05D		BRA $238E		; $5E(R0)

2330	8104		LBI R1, #$04
2332	C516		SBC R5, R1
2334	A023		BRA $235A		; $24(R0)

2336	A404		ADD R4, #$05
2338	D541		MOVE R5, (R4)+
233A	3575		MOVE $EA, R5
233C	8180		LBI R1, #$80
233E	C51F		SNBSH R5, R1
2340	A049		BRA $238C		; $4A(R0)

2342	015C		MHL R1, R5
2344	0156		OR R1, R5
2346	C10B		SNZ R1
2348	A041		BRA $238C		; $42(R0)

234A	D448		MOVE R4, (R4)
234C	A405		ADD R4, #$06
234E	5548		MOVE (R4), R5
2350	0433		INC2 R4, R3
2352	D848		MOVE R8, (R4)
2354	8102		LBI R1, #$02
2356	C815		SBS R8, R1
...
236C	D748		MOVE R7, (R4)
236E	8102		LBI R1, #$02
2370	C715		SBS R7, R1
2372	A01B		BRA $2390		; $1C(R0)

2374	A405		ADD R4, #$06
2376	D748		MOVE R7, (R4)
...
244E	C60B		SNZ R6
2450	A013		BRA $2466		; $14(R0)

2452	2529		MOVE R5, $52
2454	81C4		LBI R1, #$C4
2456	C51A		SNE R5, R1
2458	A02B		BRA $2486		; $2C(R0)
...
2468	A403		ADD R4, #$04
246A	D743		MOVE R7, (R4)++
246C	2575		MOVE R5, $EA
246E	5548		MOVE (R4), R5
2470	2848		MOVE R8, $90
2472	8110		LBI R1, #$10
2474	C815		SBS R8, R1
2476	A011		BRA $248A		; $12(R0)
...
2480	81C4		LBI R1, #$C4
2482	C812		SE R8, R1
2484	A003		BRA $248A		; $04(R0)

2486	8610		LBI R6, #$10
2488	F02D		BRA $245C		; -> -$2E(R0)

248A	A405		ADD R4, #$06
248C	5747		MOVE (R4)--, R7
248E	D448		MOVE R4, (R4)
2490	A408		ADD R4, #$09
2492	8104		LBI R1, #$04
2494	7146		MOVB (R4)---, R1
2496	5548		MOVE (R4), R5
...
24A4	F0BF		BRA $23E6		; -> -$C0(R0)

24A6	0434		MOVE R4, R3
24A8	A40D		ADD R4, #$0E
24AA	DF48		MOVE R15, (R4)
24AC	01FC		MHL R1, R15
24AE	01F6		OR R1, R15
24B0	C10B		SNZ R1
24B2	A037		BRA $24EC		; $38(R0)

24B4	8180		LBI R1, #$80
24B6	CF1F		SNBSH R15, R1
24B8	A031		BRA $24EC		; $32(R0)

24BA	F403		SUB R4, #$04
24BC	D448		MOVE R4, (R4)
24BE	A405		ADD R4, #$06
24C0	D548		MOVE R5, (R4)
24C2	015C		MHL R1, R5
24C4	0156		OR R1, R5
24C6	C10B		SNZ R1
24C8	A021		BRA $24EC		; $22(R0)
...
24EC	865E		LBI R6, #$5E
24EE	A08D		BRA $257E		; $8E(R0)

24F0	2550		MOVE R5, $A0
24F2	354D		MOVE $9A, R5
24F4	354E		MOVE $9C, R5
24F6	8507		LBI R5, #$07
24F8	354F		MOVE $9E, R5
24FA	85D0		LBI R5, #$D0
...
2512	8140		LBI R1, #$40
2514	C51A		SNE R5, R1
2516	A003		BRA $251C		; $04(R0)

2518	8630		LBI R6, #$30
251A	A061		BRA $257E		; $62(R0)
...
2528	A407		ADD R4, #$08
252A	D548		MOVE R5, (R4)
252C	015C		MHL R1, R5
252E	0516		OR R5, R1
2530	C50B		SNZ R5
2532	F08F		BRA $24A4		; -> -$90(R0)
...
272A	A403		ADD R4, #$04
272C	D748		MOVE R7, (R4)
272E	C7D2		SE R7, R13
2730	A041		BRA $2774		; $42(R0)

2732	077C		MHL R7, R7
2734	C752		SE R7, R5
2736	A03B		BRA $2774		; $3C(R0)
...
2760	A403		ADD R4, #$04
2762	D548		MOVE R5, (R4)
2764	A500		ADD R5, #$01
2766	07DC		MHL R7, R13
2768	085C		MHL R8, R5
276A	C780		SLE R7, R8
276C	A005		BRA $2774		; $06(R0)
...
27A0	A405		ADD R4, #$06
27A2	DF48		MOVE R15, (R4)
27A4	2447		MOVE R4, $8E
27A6	A42A		ADD R4, #$2B
...
29A2	D448		MOVE R4, (R4)
29A4	A407		ADD R4, #$08
29A6	6F48		MOVB R15, (R4)
...
29CE	865E		LBI R6, #$5E
29D0	A035		BRA $2A08		; $36(R0)

29D2	3274		MOVE $E8, R2
29D4	0434		MOVE R4, R3
29D6	A40D		ADD R4, #$0E
29D8	D547		MOVE R5, (R4)--
29DA	3547		MOVE $8E, R5
29DC	D448		MOVE R4, (R4)
29DE	A405		ADD R4, #$06
29E0	D548		MOVE R5, (R4)
29E2	357B		MOVE $F6, R5
...
29FA	C60B		SNZ R6
29FC	A013		BRA $2A12		; $14(R0)

29FE	2529		MOVE R5, $52
2A00	81C4		LBI R1, #$C4
2A02	C51A		SNE R5, R1
2A04	A0C5		BRA $2ACC		; $C6(R0)
...
2A14	8110		LBI R1, #$10
2A16	C515		SBS R5, R1
2A18	A00F		BRA $2A2A		; $10(R0)

2A1A	257B		MOVE R5, $F6
2A1C	8101		LBI R1, #$01
2A1E	C516		SBC R5, R1
2A20	A067		BRA $2A8A		; $68(R0)

2A22	2529		MOVE R5, $52
2A24	81C4		LBI R1, #$C4
2A26	C51A		SNE R5, R1
2A28	A073		BRA $2A9E		; $74(R0)
...
2A9E	2547		MOVE R5, $8E
2AA0	F500		SUB R5, #$01
2AA2	3547		MOVE $8E, R5
2AA4	015C		MHL R1, R5
2AA6	0516		OR R5, R1
2AA8	C503		SZ R5
2AAA	A007		BRA $2AB4		; $08(R0)

2AAC	A045		BRA $2AF4		; $46(R0)

2AAE	2547		MOVE R5, $8E
2AB0	F500		SUB R5, #$01
2AB2	3547		MOVE $8E, R5
2AB4	257B		MOVE R5, $F6
2AB6	A500		ADD R5, #$01
2AB8	357B		MOVE $F6, R5
...
2AC4	81C4		LBI R1, #$C4
2AC6	C512		SE R5, R1
2AC8	F099		BRA $2A30		; -> -$9A(R0)

2ACA	F05D		BRA $2A6E		; -> -$5E(R0)
...
2E04	8140		LBI R1, #$40
2E06	C512		SE R5, R1
2E08	A019		BRA $2E24		; $1A(R0)

2E0A	A417		ADD R4, #$18
2E0C	8F06		LBI R15, #$06
2E0E	6540		MOVB R5, (R4)+
2E10	8140		LBI R1, #$40
2E12	C512		SE R5, R1
2E14	A00D		BRA $2E24		; $0E(R0)
...
2F2E	A400		ADD R4, #$01
2F30	6848		MOVB R8, (R4)
2F32	9880		CLR R8, #$80
2F34	0FD4		MOVE R15, R13
2F36	0154		MOVE R1, R5
2F38	0189		SUB R1, R8
2F3A	0F19		SUB R15, R1
2F3C	8880		LBI R8, #$80
2F3E	0203		INC2 R2, R0
2F40	A01D		BRA $2F60		; $1E(R0)
...
2F54	A707		ADD R7, #$08
2F56	F011		BRA $2F46		; -> -$12(R0)

2F58	0F58		ADD R15, R5
2F5A	E05E		ROR3 R5
2F5C	0204		MOVE R2, R0
2F5E	0F59		SUB R15, R5
...
2F80	075C		MHL R7, R5
2F82	374D		MOVE $9A, R7
2F84	2750		MOVE R7, $A0
2F86	8180		LBI R1, #$80
2F88	C516		SBC R5, R1
2F8A	8701		LBI R7, #$01
2F8C	374E		MOVE $9C, R7
...
2FE8	3242		MOVE $84, R2
2FEA	0F54		MOVE R15, R5
2FEC	8131		LBI R1, #$31
2FEE	011D		MLH R1, R1
2FF0	81BA		LBI R1, #$BA
...
2FF6	0754		MOVE R7, R5
2FF8	08F4		MOVE R8, R15
2FFA	0789		SUB R7, R8
2FFC	087C		MHL R8, R7
2FFE	077D		MLH R7, R7
3000	078C		MHL R7, R8
...
3006	078D		MLH R7, R8
3008	8180		LBI R1, #$80
300A	C717		SBSH R7, R1
300C	A00B		BRA $301A		; $0C(R0)
...
301A	2750		MOVE R7, $A0
301C	2850		MOVE R8, $A0
301E	01FC		MHL R1, R15
3020	C103		SZ R1
3022	A009		BRA $302E		; $0A(R0)

3024	8113		LBI R1, #$13
3026	CF10		SLE R15, R1
3028	A003		BRA $302E		; $04(R0)

302A	AF06		ADD R15, #$07
302C	A037		BRA $3066		; $38(R0)
...
3034	812D		LBI R1, #$2D
3036	C512		SE R5, R1
3038	A005		BRA $3040		; $06(R0)

303A	8701		LBI R7, #$01
303C	FF12		SUB R15, #$13
303E	A025		BRA $3066		; $26(R0)
...
3050	C70B		SNZ R7
3052	A800		ADD R8, #$01
3054	FF19		SUB R15, #$1A
3056	01FC		MHL R1, R15
3058	01F6		OR R1, R15
305A	C10B		SNZ R1
305C	A005		BRA $3064		; $06(R0)

305E	8180		LBI R1, #$80
3060	CF17		SBSH R15, R1
3062	F017		BRA $304C		; -> -$18(R0)

3064	AF19		ADD R15, #$1A
3066	374E		MOVE $9C, R7
3068	384D		MOVE $9A, R8
306A	3F4F		MOVE $9E, R15
306C	81D0		LBI R1, #$D0
306E	314C		MOVE $98, R1
3070	2042		JMP ($0084)

3072	3241		MOVE $82, R2
3074	254D		MOVE R5, $9A
3076	0203		INC2 R2, R0
3078	A017		BRA $3092		; $18(R0)

307A	5541		MOVE (R4)+, R5
307C	254E		MOVE R5, $9C
307E	0203		INC2 R2, R0
3080	A00F		BRA $3092		; $10(R0)

3082	7541		MOVB (R4)++, R5
3084	254F		MOVE R5, $9E
...
30AA	3243		MOVE $86, R2
30AC	3447		MOVE $8E, R4
30AE	81C8		LBI R1, #$C8
30B0	6540		MOVB R5, (R4)+
30B2	C512		SE R5, R1
30B4	A047		BRA $30FE		; $48(R0)

30B6	81C4		LBI R1, #$C4
30B8	6540		MOVB R5, (R4)+
30BA	C512		SE R5, R1
30BC	A03F		BRA $30FE		; $40(R0)

30BE	81D9		LBI R1, #$D9
30C0	6540		MOVB R5, (R4)+
30C2	C512		SE R5, R1
30C4	A037		BRA $30FE		; $38(R0)

30C6	81F1		LBI R1, #$F1
30C8	6548		MOVB R5, (R4)
30CA	C512		SE R5, R1
30CC	A02F		BRA $30FE		; $30(R0)
...
30D8	95F0		CLR R5, #$F0
30DA	2447		MOVE R4, $8E
30DC	A42A		ADD R4, #$2B
30DE	6748		MOVB R7, (R4)
30E0	8140		LBI R1, #$40
30E2	C71A		SNE R7, R1
30E4	A011		BRA $30F8		; $12(R0)

30E6	81C8		LBI R1, #$C8
30E8	C712		SE R7, R1
30EA	A007		BRA $30F4		; $08(R0)

30EC	8140		LBI R1, #$40
30EE	7148		MOVB (R4), R1
30F0	8701		LBI R7, #$01
30F2	A003		BRA $30F8		; $04(R0)

30F4	F409		SUB R4, #$0A
30F6	6748		MOVB R7, (R4)
30F8	97F0		CLR R7, #$F0
30FA	C57A		SNE R5, R7
...
3104	A809		ADD R8, #$0A
3106	D888		MOVE R8, (R8)
3108	A807		ADD R8, #$08
310A	7788		MOVB (R8), R7
310C	2447		MOVE R4, $8E
310E	A41B		ADD R4, #$1C
3110	0203		INC2 R2, R0
3112	A0DB		BRA $31F0		; $DC(R0)

3114	0203		INC2 R2, R0
3116	A065		BRA $317E		; $66(R0)

3118	2447		MOVE R4, $8E
311A	A421		ADD R4, #$22
311C	D548		MOVE R5, (R4)
311E	8132		LBI R1, #$32
3120	011D		MLH R1, R1
3122	815A		LBI R1, #$5A
...
3174	075D		MLH R7, R5
3176	8180		LBI R1, #$80
3178	C71F		SNBSH R7, R1
317A	F07D		BRA $30FE		; -> -$7E(R0)

317C	2043		JMP ($0086)

317E	3242		MOVE $84, R2
3180	0203		INC2 R2, R0
3182	A013		BRA $3198		; $14(R0)

3184	354E		MOVE $9C, R5
3186	0203		INC2 R2, R0
3188	A079		BRA $3204		; $7A(R0)
...
3198	3241		MOVE $82, R2
319A	0203		INC2 R2, R0
319C	A065		BRA $3204		; $66(R0)
...
31BA	3241		MOVE $82, R2
31BC	0203		INC2 R2, R0
31BE	A043		BRA $3204		; $44(R0)
...
31DE	E05F		SWAP R5
31E0	C50B		SNZ R5
31E2	A007		BRA $31EC		; $08(R0)

31E4	A767		ADD R7, #$68
31E6	F500		SUB R5, #$01
31E8	C503		SZ R5
31EA	F007		BRA $31E4		; -> -$08(R0)

31EC	0574		MOVE R5, R7
31EE	2041		JMP ($0082)

31F0	3242		MOVE $84, R2
31F2	D542		MOVE R5, (R4)+'
31F4	0203		INC2 R2, R0
31F6	A061		BRA $325A		; $62(R0)

31F8	814A		LBI R1, #$4A
31FA	C810		SLE R8, R1
31FC	A057		BRA $3256		; $58(R0)

31FE	0F84		MOVE R15, R8
3200	0744		MOVE R7, R4
3202	0203		INC2 R2, R0
3204	A07D		BRA $3284		; $7E(R0)
...
320E	950F		CLR R5, #$0F
3210	E05F		SWAP R5
3212	CF58		SGT R15, R5
3214	A03F		BRA $3256		; $40(R0)

3216	0474		MOVE R4, R7
3218	6740		MOVB R7, (R4)+
321A	6545		MOVB R5, (R4)--
321C	057D		MLH R5, R7
321E	0203		INC2 R2, R0
3220	A037		BRA $325A		; $38(R0)

3222	08FD		MLH R8, R15
3224	6548		MOVB R5, (R4)
3226	87F0		LBI R7, #$F0
3228	C57A		SNE R5, R7
322A	A00B		BRA $3238		; $0C(R0)

322C	8140		LBI R1, #$40
322E	C61A		SNE R6, R1
3230	A023		BRA $3256		; $24(R0)

3232	87F1		LBI R7, #$F1
3234	C572		SE R5, R7
3236	A01D		BRA $3256		; $1E(R0)
...
3240	A709		ADD R7, #$0A
3242	D778		MOVE R7, (R7)
3244	5878		MOVE (R7), R8
3246	0203		INC2 R2, R0
3248	F0B1		BRA $3198		; -> -$B2(R0)

324A	D778		MOVE R7, (R7)
324C	9780		CLR R7, #$80
324E	C703		SZ R7
3250	C750		SLE R7, R5
3252	A001		BRA $3256		; $02(R0)

3254	2042		JMP ($0084)

3256	8616		LBI R6, #$16
3258	A0A9		BRA $3304		; $AA(R0)

325A	075C		MHL R7, R5
325C	88F0		LBI R8, #$F0
325E	C78D		SNBS R7, R8
3260	C585		SBS R5, R8
3262	F00D		BRA $3256		; -> -$0E(R0)

3264	97F0		CLR R7, #$F0
3266	8109		LBI R1, #$09
3268	C710		SLE R7, R1
326A	F015		BRA $3256		; -> -$16(R0)

326C	2850		MOVE R8, $A0
326E	C70B		SNZ R7
3270	A005		BRA $3278		; $06(R0)

3272	A809		ADD R8, #$0A
3274	F700		SUB R7, #$01
3276	F009		BRA $326E		; -> -$0A(R0)

3278	95F0		CLR R5, #$F0
327A	8109		LBI R1, #$09
327C	C510		SLE R5, R1
327E	F029		BRA $3256		; -> -$2A(R0)
...
3286	3241		MOVE $82, R2
3288	D542		MOVE R5, (R4)+'
328A	0203		INC2 R2, R0
328C	F033		BRA $325A		; -> -$34(R0)

328E	0B84		MOVE R11, R8
3290	6840		MOVB R8, (R4)+
3292	6545		MOVB R5, (R4)--
3294	058D		MLH R5, R8
3296	0203		INC2 R2, R0
3298	F03F		BRA $325A		; -> -$40(R0)

329A	0D84		MOVE R13, R8
329C	6C41		MOVB R12, (R4)++
329E	87F0		LBI R7, #$F0
32A0	CC7A		SNE R12, R7
32A2	A00D		BRA $32B2		; $0E(R0)

32A4	254D		MOVE R5, $9A
32A6	214E		MOVE R1, $9C
32A8	C51A		SNE R5, R1
32AA	A055		BRA $3302		; $56(R0)

32AC	87F1		LBI R7, #$F1
32AE	CC72		SE R12, R7
32B0	A04F		BRA $3302		; $50(R0)

32B2	9CF0		CLR R12, #$F0
32B4	0734		MOVE R7, R3
32B6	A709		ADD R7, #$0A
32B8	D778		MOVE R7, (R7)
32BA	D578		MOVE R5, (R7)
32BC	2750		MOVE R7, $A0
32BE	015C		MHL R1, R5
32C0	0B19		SUB R11, R1
32C2	8180		LBI R1, #$80
32C4	CB1F		SNBSH R11, R1
32C6	A039		BRA $3302		; $3A(R0)

32C8	CB0B		SNZ R11
32CA	A007		BRA $32D4		; $08(R0)

32CC	214D		MOVE R1, $9A
32CE	0718		ADD R7, R1
32D0	FB00		SUB R11, #$01
32D2	F00B		BRA $32C8		; -> -$0C(R0)
...
3318	F40B		SUB R4, #$0C
331A	D538		MOVE R5, (R3)
331C	0558		ADD R5, R5
331E	C50B		SNZ R5
3320	A003		BRA $3326		; $04(R0)

3322	A401		ADD R4, #$02
3324	F009		BRA $331C		; -> -$0A(R0)
...
3338	A407		ADD R4, #$08
333A	D748		MOVE R7, (R4)
333C	8180		LBI R1, #$80
333E	C71F		SNBSH R7, R1
3340	A037		BRA $337A		; $38(R0)

3342	A401		ADD R4, #$02
3344	D448		MOVE R4, (R4)
3346	A401		ADD R4, #$02
...
3358	058D		MLH R5, R8
335A	8180		LBI R1, #$80
335C	C51F		SNBSH R5, R1
335E	0024		RET R2

3360	A401		ADD R4, #$02
3362	D848		MOVE R8, (R4)
...
3374	8180		LBI R1, #$80
3376	8650		LBI R6, #$50
3378	C81F		SNBSH R8, R1
337A	864E		LBI R6, #$4E
337C	F079		BRA $3304		; -> -$7A(R0)

337E	0434		MOVE R4, R3
3380	A403		ADD R4, #$04
3382	D448		MOVE R4, (R4)
3384	A446		ADD R4, #$47
3386	6748		MOVB R7, (R4)
3388	A403		ADD R4, #$04
338A	6848		MOVB R8, (R4)
338C	8140		LBI R1, #$40
338E	C71A		SNE R7, R1
3390	A01D		BRA $33B0		; $1E(R0)

3392	ED5F		STAT R5, $D
3394	8104		LBI R1, #$04
3396	C515		SBS R5, R1
3398	A011		BRA $33AC		; $12(R0)

339A	81F2		LBI R1, #$F2
339C	C71A		SNE R7, R1
339E	A00F		BRA $33B0		; $10(R0)

33A0	81D4		LBI R1, #$D4
33A2	C712		SE R7, R1
33A4	A005		BRA $33AC		; $06(R0)

33A6	8140		LBI R1, #$40
33A8	C812		SE R8, R1
33AA	A00F		BRA $33BC		; $10(R0)
...
33B0	81F3		LBI R1, #$F3
33B2	C81A		SNE R8, R1
33B4	F009		BRA $33AC		; -> -$0A(R0)

33B6	8140		LBI R1, #$40
33B8	C81A		SNE R8, R1
33BA	A00B		BRA $33C8		; $0C(R0)

33BC	81F1		LBI R1, #$F1
33BE	C819		SGE R8, R1
33C0	F015		BRA $33AC		; -> -$16(R0)

33C2	81F3		LBI R1, #$F3
33C4	C810		SLE R8, R1
33C6	F01B		BRA $33AC		; -> -$1C(R0)

33C8	98F0		CLR R8, #$F0
33CA	8140		LBI R1, #$40
33CC	C712		SE R7, R1
33CE	A019		BRA $33EA		; $1A(R0)

33D0	A400		ADD R4, #$01
33D2	D548		MOVE R5, (R4)
33D4	8140		LBI R1, #$40
33D6	C51A		SNE R5, R1
33D8	A031		BRA $340C		; $32(R0)

33DA	81F1		LBI R1, #$F1
33DC	C512		SE R5, R1
33DE	A005		BRA $33E6		; $06(R0)

33E0	055C		MHL R5, R5
33E2	81F0		LBI R1, #$F0
33E4	C512		SE R5, R1
33E6	B880		SET R8, #$80
33E8	A021		BRA $340C		; $22(R0)

33EA	81D4		LBI R1, #$D4
33EC	C712		SE R7, R1
33EE	A01B		BRA $340C		; $1C(R0)

33F0	F40A		SUB R4, #$0B
33F2	6548		MOVB R5, (R4)
33F4	8140		LBI R1, #$40
33F6	C51A		SNE R5, R1
33F8	A00B		BRA $3406		; $0C(R0)

33FA	81F1		LBI R1, #$F1
33FC	C519		SGE R5, R1
33FE	F053		BRA $33AC		; -> -$54(R0)

3400	81F9		LBI R1, #$F9
3402	C510		SLE R5, R1
3404	F059		BRA $33AC		; -> -$5A(R0)
...
342C	C80B		SNZ R8
342E	8F80		LBI R15, #$80
3430	0434		MOVE R4, R3
3432	A405		ADD R4, #$06
3434	5F48		MOVE (R4), R15
3436	0024		RET R2

3438	3245		MOVE $8A, R2
...
3462	C60B		SNZ R6
3464	A035		BRA $349C		; $36(R0)

3466	8180		LBI R1, #$80
3468	C615		SBS R6, R1
346A	A02F		BRA $349C		; $30(R0)

346C	2551		MOVE R5, $A2
346E	8180		LBI R1, #$80
3470	C51F		SNBSH R5, R1
3472	A00B		BRA $3480		; $0C(R0)

3474	254A		MOVE R5, $94
3476	A500		ADD R5, #$01
3478	354A		MOVE $94, R5
347A	810A		LBI R1, #$0A
347C	C519		SGE R5, R1
347E	F041		BRA $343E		; -> -$42(R0)

3480	8120		LBI R1, #$20
3482	C61D		SNBS R6, R1
3484	A00B		BRA $3492		; $0C(R0)
...
3492	2729		MOVE R7, $52
3494	81C4		LBI R1, #$C4
3496	C71A		SNE R7, R1
3498	F013		BRA $3486		; -> -$14(R0)

349A	9680		CLR R6, #$80
349C	2045		JMP ($008A)

349E	3245		MOVE $8A, R2
34A0	2550		MOVE R5, $A0
34A2	354A		MOVE $94, R5
...
34BE	2522		MOVE R5, $44
34C0	3523		MOVE $46, R5
34C2	F405		SUB R4, #$06
34C4	DD48		MOVE R13, (R4)
34C6	3D2C		MOVE $58, R13
34C8	252E		MOVE R5, $5C
34CA	352D		MOVE $5A, R5
34CC	812F		LBI R1, #$2F
34CE	011D		MLH R1, R1
34D0	8112		LBI R1, #$12
...
370C	8580		LBI R5, #$80
370E	950F		CLR R5, #$0F
3710	272E		MOVE R7, $5C
3712	0758		ADD R7, R5
3714	057C		MHL R5, R7
3716	055A		ADDH R5, R5
3718	075D		MLH R7, R5
371A	372E		MOVE $5C, R7
371C	0024		RET R2

371E	3242		MOVE $84, R2
3720	0434		MOVE R4, R3
3722	A407		ADD R4, #$08
3724	6840		MOVB R8, (R4)+
3726	814C		LBI R1, #$4C
3728	C818		SGT R8, R1
372A	A003		BRA $3730		; $04(R0)

372C	865E		LBI R6, #$5E
372E	F0C3		BRA $366C		; -> -$C4(R0)

3730	384D		MOVE $9A, R8
3732	6748		MOVB R7, (R4)
3734	2550		MOVE R5, $A0
3736	8180		LBI R1, #$80
3738	C716		SBC R7, R1
373A	8501		LBI R5, #$01
373C	354E		MOVE $9C, R5
373E	9780		CLR R7, #$80
3740	C70B		SNZ R7
3742	F017		BRA $372C		; -> -$18(R0)

3744	C80B		SNZ R8
3746	A019		BRA $3762		; $1A(R0)
...
3778	C750		SLE R7, R5
377A	F04F		BRA $372C		; -> -$50(R0)

377C	374F		MOVE $9E, R7
377E	2042		JMP ($0084)

3780	3244		MOVE $88, R2
...
37AA	CB5A		SNE R11, R5
37AC	A051		BRA $3800		; $52(R0)

37AE	C5B8		SGT R5, R11
37B0	A00D		BRA $37C0		; $0E(R0)

37B2	05B9		SUB R5, R11
37B4	0F54		MOVE R15, R5
37B6	8A00		LBI R10, #$00
37B8	2148		MOVE R1, $90
37BA	B180		SET R1, #$80
37BC	3148		MOVE $90, R1
37BE	A00B		BRA $37CC		; $0C(R0)

37C0	0FB4		MOVE R15, R11
37C2	0F59		SUB R15, R5
37C4	8AFF		LBI R10, #$FF
...
382E	8108		LBI R1, #$08
3830	C515		SBS R5, R1
3832	F025		BRA $380E		; -> -$26(R0)

3834	1442		CTRL $4, #$42
3836	2550		MOVE R5, $A0
3838	354C		MOVE $98, R5
383A	F02D		BRA $380E		; -> -$2E(R0)

383C	863E		LBI R6, #$3E
383E	A03E		BRA $387F		; $3F(R0)

3840	254D		MOVE R5, $9A
3842	C5BA		SNE R5, R11
3844	A02F		BRA $3876		; $30(R0)

3846	1D01		CTRL $D, #$01
3848	144A		CTRL $4, #$4A
384A	254B		MOVE R5, $96
384C	A500		ADD R5, #$01
384E	354B		MOVE $96, R5
3850	8705		LBI R7, #$05
3852	C571		SLT R5, R7
3854	A005		BRA $385C		; $06(R0)

3856	0203		INC2 R2, R0
3858	A059		BRA $38B4		; $5A(R0)

385A	F051		BRA $380A		; -> -$52(R0)
...
3872	862C		LBI R6, #$2C
3874	A009		BRA $3880		; $0A(R0)

3876	214E		MOVE R1, $9C
3878	CC1A		SNE R12, R1
387A	A00D		BRA $388A		; $0E(R0)
...
388A	214F		MOVE R1, $9E
388C	CD1A		SNE R13, R1
388E	A00D		BRA $389E		; $0E(R0)
...
38AA	F900		SUB R9, #$01
38AC	C903		SZ R9
38AE	F00D		BRA $38A2		; -> -$0E(R0)

38B0	861E		LBI R6, #$1E
38B2	F033		BRA $3880		; -> -$34(R0)

38B4	3243		MOVE $86, R2
38B6	CB0C		SNS R11
38B8	A025		BRA $38E0		; $26(R0)

38BA	2F4D		MOVE R15, $9A
38BC	CFB8		SGT R15, R11
38BE	A00D		BRA $38CE		; $0E(R0)

38C0	0FB9		SUB R15, R11
38C2	8A00		LBI R10, #$00
...
38D0	07F9		SUB R7, R15
38D2	0F74		MOVE R15, R7
38D4	8AFF		LBI R10, #$FF
...
3956	B820		SET R8, #$20
3958	C703		SZ R7
395A	A005		BRA $3962		; $06(R0)

395C	274E		MOVE R7, $9C
395E	C70B		SNZ R7
3960	A019		BRA $397C		; $1A(R0)
...
396E	81D4		LBI R1, #$D4
3970	C512		SE R5, R1
3972	A007		BRA $397C		; $08(R0)

3974	2148		MOVE R1, $90
3976	B110		SET R1, #$10
3978	3148		MOVE $90, R1
397A	B840		SET R8, #$40
397C	214E		MOVE R1, $9C
397E	C103		SZ R1
3980	A003		BRA $3986		; $04(R0)

3982	9804		CLR R8, #$04
3984	A00B		BRA $3992		; $0C(R0)

3986	8140		LBI R1, #$40
3988	C512		SE R5, R1
398A	A003		BRA $3990		; $04(R0)

398C	862A		LBI R6, #$2A
398E	A0AB		BRA $3A3C		; $AC(R0)
...
39A0	ED5F		STAT R5, $D
39A2	075D		MLH R7, R5
39A4	3774		MOVE $E8, R7
39A6	861C		LBI R6, #$1C
39A8	A091		BRA $3A3C		; $92(R0)

39AA	3242		MOVE $84, R2
...
39BC	C60B		SNZ R6
39BE	A01F		BRA $39E0		; $20(R0)

39C0	1D01		CTRL $D, #$01
39C2	254F		MOVE R5, $9E
39C4	C5D2		SE R5, R13
39C6	A01F		BRA $39E8		; $20(R0)

39C8	2551		MOVE R5, $A2
39CA	8180		LBI R1, #$80
39CC	C51F		SNBSH R5, R1
39CE	A00B		BRA $39DC		; $0C(R0)

39D0	2549		MOVE R5, $92
39D2	A500		ADD R5, #$01
39D4	3549		MOVE $92, R5
39D6	810A		LBI R1, #$0A
39D8	C519		SGE R5, R1
39DA	A00B		BRA $39E8		; $0C(R0)

39DC	8642		LBI R6, #$42
39DE	A05B		BRA $3A3C		; $5C(R0)

39E0	254F		MOVE R5, $9E
39E2	C5DA		SNE R5, R13
39E4	2042		JMP ($0084)
...
39EE	8108		LBI R1, #$08
39F0	C515		SBS R5, R1
39F2	A003		BRA $39F8		; $04(R0)

39F4	1442		CTRL $4, #$42
39F6	8800		LBI R8, #$00
39F8	254C		MOVE R5, $98
39FA	C859		SGE R8, R5
39FC	F04B		BRA $39B2		; -> -$4C(R0)
...
3A12	F063		BRA $39B0		; -> -$64(R0)

3A14	0434		MOVE R4, R3
3A16	A403		ADD R4, #$04
3A18	D448		MOVE R4, (R4)
3A1A	81E5		LBI R1, #$E5
3A1C	6740		MOVB R7, (R4)+
3A1E	C712		SE R7, R1
3A20	A017		BRA $3A3A		; $18(R0)

3A22	81D6		LBI R1, #$D6
3A24	6740		MOVB R7, (R4)+
3A26	C712		SE R7, R1
3A28	A00F		BRA $3A3A		; $10(R0)

3A2A	81D3		LBI R1, #$D3
3A2C	6740		MOVB R7, (R4)+
3A2E	C712		SE R7, R1
3A30	A007		BRA $3A3A		; $08(R0)

3A32	81F1		LBI R1, #$F1
3A34	6748		MOVB R7, (R4)
3A36	C71A		SNE R7, R1
3A38	A00B		BRA $3A46		; $0C(R0)
...
3A46	A406		ADD R4, #$07
3A48	8140		LBI R1, #$40
3A4A	6748		MOVB R7, (R4)
3A4C	C71A		SNE R7, R1
3A4E	A003		BRA $3A54		; $04(R0)

3A50	860C		LBI R6, #$0C
3A52	F017		BRA $3A3C		; -> -$18(R0)

3A54	A43E		ADD R4, #$3F
3A56	8140		LBI R1, #$40
3A58	6748		MOVB R7, (R4)
3A5A	C712		SE R7, R1
3A5C	A009		BRA $3A68		; $0A(R0)

3A5E	A405		ADD R4, #$06
3A60	81E6		LBI R1, #$E6
3A62	6748		MOVB R7, (R4)
3A64	C71A		SNE R7, R1
3A66	0024		RET R2

3A68	8630		LBI R6, #$30
3A6A	F02F		BRA $3A3C		; -> -$30(R0)

3A6C	3242		MOVE $84, R2
...
3A9A	8703		LBI R7, #$03
3A9C	C57A		SNE R5, R7
3A9E	A025		BRA $3AC6		; $26(R0)

3AA0	2F50		MOVE R15, $A0
3AA2	8701		LBI R7, #$01
3AA4	C570		SLE R5, R7
3AA6	AF00		ADD R15, #$01
3AA8	C572		SE R5, R7
3AAA	AF00		ADD R15, #$01
3AAC	AF00		ADD R15, #$01
3AAE	8AFF		LBI R10, #$FF
3AB0	813D		LBI R1, #$3D
3AB2	011D		MLH R1, R1
3AB4	810C		LBI R1, #$0C
...
3ABC	B5FC		SET R5, #$FC
3ABE	C50C		SNS R5
3AC0	A003		BRA $3AC6		; $04(R0)

3AC2	862C		LBI R6, #$2C
3AC4	A095		BRA $3B5C		; $96(R0)

3AC6	8B00		LBI R11, #$00
3AC8	0203		INC2 R2, R0
3ACA	A0AF		BRA $3B7C		; $B0(R0)
...
3AEE	A057		BRA $3B48		; $58(R0)

3AF0	0203		INC2 R2, R0
3AF2	A0B3		BRA $3BA8		; $B4(R0)
...
3AFE	8710		LBI R7, #$10
3B00	C575		SBS R5, R7
3B02	A005		BRA $3B0A		; $06(R0)

3B04	8700		LBI R7, #$00
3B06	0203		INC2 R2, R0
3B08	A03D		BRA $3B48		; $3E(R0)

3B0A	8710		LBI R7, #$10
3B0C	0203		INC2 R2, R0
3B0E	A037		BRA $3B48		; $38(R0)
...
3B1C	F007		BRA $3B16		; -> -$08(R0)

3B1E	ED5F		STAT R5, $D
3B20	8110		LBI R1, #$10
3B22	C516		SBC R5, R1
3B24	A031		BRA $3B58		; $32(R0)
...
3B30	A033		BRA $3B66		; $34(R0)

3B32	A00B		BRA $3B40		; $0C(R0)

3B34	8902		LBI R9, #$02
3B36	099D		MLH R9, R9
3B38	89F7		LBI R9, #$F7
3B3A	0203		INC2 R2, R0
3B3C	A027		BRA $3B66		; $28(R0)

3B3E	A003		BRA $3B44		; $04(R0)

3B40	8660		LBI R6, #$60
3B42	A015		BRA $3B5A		; $16(R0)
...
3B6C	0023		INC2 R0, R2
3B6E	ED5F		STAT R5, $D
3B70	8110		LBI R1, #$10
3B72	C515		SBS R5, R1
3B74	F00F		BRA $3B66		; -> -$10(R0)
...
3B80	F40F		SUB R4, #$10
3B82	D538		MOVE R5, (R3)
3B84	0558		ADD R5, R5
3B86	C50B		SNZ R5
3B88	A003		BRA $3B8E		; $04(R0)

3B8A	A400		ADD R4, #$01
3B8C	F009		BRA $3B84		; -> -$0A(R0)

3B8E	CA04		SS R10
3B90	A003		BRA $3B96		; $04(R0)

3B92	6B48		MOVB R11, (R4)
3B94	0024		RET R2

3B96	7B48		MOVB (R4), R11
3B98	0024		RET R2

3B9A	3241		MOVE $82, R2
3B9C	1D01		CTRL $D, #$01
3B9E	8108		LBI R1, #$08
3BA0	0D5E		GETB R5, $D
3BA2	C516		SBC R5, R1
3BA4	A003		BRA $3BAA		; $04(R0)

3BA6	0203		INC2 R2, R0
3BA8	A085		BRA $3C30		; $86(R0)
...
3BB2	8416		LBI R4, #$16
3BB4	3424		MOVE $48, R4
3BB6	2F50		MOVE R15, $A0
3BB8	8F04		LBI R15, #$04
3BBA	3F2F		MOVE $5E, R15
3BBC	2750		MOVE R7, $A0
3BBE	372A		MOVE $54, R7
3BC0	873C		LBI R7, #$3C
3BC2	077D		MLH R7, R7
3BC4	875E		LBI R7, #$5E
3BC6	3720		MOVE $40, R7
3BC8	8600		LBI R6, #$00
3BCA	3626		MOVE $4C, R6
3BCC	1443		CTRL $4, #$43
3BCE	1D40		CTRL $D, #$40
3BD0	144B		CTRL $4, #$4B
3BD2	0203		INC2 R2, R0
3BD4	A03B		BRA $3C12		; $3C(R0)

3BD6	2525		MOVE R5, $4A
3BD8	81FE		LBI R1, #$FE
3BDA	C51A		SNE R5, R1
3BDC	A003		BRA $3BE2		; $04(R0)

3BDE	1D01		CTRL $D, #$01
3BE0	F031		BRA $3BB0		; -> -$32(R0)

3BE2	8900		LBI R9, #$00
3BE4	099D		MLH R9, R9
3BE6	8933		LBI R9, #$33
3BE8	2750		MOVE R7, $A0
3BEA	372A		MOVE $54, R7
3BEC	144B		CTRL $4, #$4B
3BEE	0203		INC2 R2, R0
3BF0	A01F		BRA $3C12		; $20(R0)

3BF2	ED5F		STAT R5, $D
3BF4	8101		LBI R1, #$01
3BF6	C515		SBS R5, R1
3BF8	A005		BRA $3C00		; $06(R0)

3BFA	1D01		CTRL $D, #$01
3BFC	8622		LBI R6, #$22
3BFE	A053		BRA $3C54		; $54(R0)

3C00	8600		LBI R6, #$00
3C02	8102		LBI R1, #$02
3C04	C516		SBC R5, R1
3C06	8680		LBI R6, #$80
3C08	0EC4		MOVE R14, R12
3C0A	0DEC		MHL R13, R14
3C0C	0CB4		MOVE R12, R11
3C0E	0BCC		MHL R11, R12
3C10	2041		JMP ($0082)

3C12	F900		SUB R9, #$01
3C14	8180		LBI R1, #$80
3C16	C91F		SNBSH R9, R1
3C18	A007		BRA $3C22		; $08(R0)

3C1A	272A		MOVE R7, $54
3C1C	C704		SS R7
3C1E	F00D		BRA $3C12		; -> -$0E(R0)
...
3C24	8101		LBI R1, #$01
3C26	C516		SBC R5, R1
3C28	F02F		BRA $3BFA		; -> -$30(R0)

3C2A	1D01		CTRL $D, #$01
3C2C	8638		LBI R6, #$38
3C2E	A023		BRA $3C54		; $24(R0)
...
3C48	F007		BRA $3C42		; -> -$08(R0)

3C4A	0D5E		GETB R5, $D
3C4C	8108		LBI R1, #$08
3C4E	C51D		SNBS R5, R1
3C50	0024		RET R2
...
3C64	9516		CLR R5, #$16
3C66	C512		SE R5, R1
3C68	A08B		BRA $3CF6		; $8C(R0)

3C6A	8AFF		LBI R10, #$FF
3C6C	0D5E		GETB R5, $D
3C6E	1447		CTRL $4, #$47
3C70	F000		BRA $3C71		; -> -$01(R0)
...
3C7C	7740		MOVB (R4)+, R7
3C7E	0974		MOVE R9, R7
3C80	FF00		SUB R15, #$01
3C82	CF8F		SNBSH R15, R8
3C84	A009		BRA $3C90		; $0A(R0)

3C86	0D7E		GETB R7, $D
3C88	7740		MOVB (R4)+, R7
3C8A	FF00		SUB R15, #$01
3C8C	CF87		SBSH R15, R8
3C8E	F009		BRA $3C86		; -> -$0A(R0)

3C90	1D04		CTRL $D, #$04
3C92	0004		NOP
3C94	0D7E		GETB R7, $D
3C96	F000		BRA $3C97		; -> -$01(R0)

3C98	0004		NOP
3C9A	7740		MOVB (R4)+, R7
3C9C	0D7E		GETB R7, $D
3C9E	F000		BRA $3C9F		; -> -$01(R0)

3CA0	7740		MOVB (R4)+, R7
3CA2	0004		NOP
3CA4	0D7E		GETB R7, $D
3CA6	F000		BRA $3CA7		; -> -$01(R0)

3CA8	0004		NOP
3CAA	8AFF		LBI R10, #$FF
3CAC	1447		CTRL $4, #$47
3CAE	0D7E		GETB R7, $D
3CB0	2F50		MOVE R15, $A0
3CB2	AF00		ADD R15, #$01
3CB4	F000		BRA $3CB5		; -> -$01(R0)

3CB6	0D7E		GETB R7, $D
3CB8	F007		BRA $3CB2		; -> -$08(R0)
...
3D02	0D5E		GETB R5, $D
3D04	057D		MLH R5, R7
3D06	3574		MOVE $E8, R5
3D08	861C		LBI R6, #$1C
3D0A	F0B7		BRA $3C54		; -> -$B8(R0)

3D0C	3241		MOVE $82, R2
3D0E	1D01		CTRL $D, #$01
3D10	8151		LBI R1, #$51
...
3D52	F007		BRA $3D4C		; -> -$08(R0)

3D54	F700		SUB R7, #$01
3D56	C703		SZ R7
3D58	F041		BRA $3D18		; -> -$42(R0)

3D5A	2041		JMP ($0082)

3D5C	3241		MOVE $82, R2
3D5E	8900		LBI R9, #$00
3D60	099D		MLH R9, R9
3D62	8967		LBI R9, #$67
3D64	3626		MOVE $4C, R6
...
3D84	A08D		BRA $3E14		; $8E(R0)

3D86	252F		MOVE R5, $5E
3D88	C589		SGE R5, R8
3D8A	F00D		BRA $3D7E		; -> -$0E(R0)

3D8C	1D01		CTRL $D, #$01
3D8E	2850		MOVE R8, $A0
3D90	382A		MOVE $54, R8
3D92	3424		MOVE $48, R4
3D94	3F2F		MOVE $5E, R15
3D96	883C		LBI R8, #$3C
3D98	088D		MLH R8, R8
3D9A	885E		LBI R8, #$5E
3D9C	3820		MOVE $40, R8
3D9E	2650		MOVE R6, $A0
3DA0	1D40		CTRL $D, #$40
3DA2	144B		CTRL $4, #$4B
3DA4	0203		INC2 R2, R0
3DA6	A03B		BRA $3DE4		; $3C(R0)

3DA8	2525		MOVE R5, $4A
3DAA	81F8		LBI R1, #$F8
3DAC	C512		SE R5, R1
3DAE	A003		BRA $3DB4		; $04(R0)

3DB0	8620		LBI R6, #$20
3DB2	A007		BRA $3DBC		; $08(R0)

3DB4	81FB		LBI R1, #$FB
3DB6	C51A		SNE R5, R1
3DB8	A001		BRA $3DBC		; $02(R0)

3DBA	F02F		BRA $3D8C		; -> -$30(R0)
...
3DC6	382A		MOVE $54, R8
3DC8	0203		INC2 R2, R0
3DCA	A017		BRA $3DE4		; $18(R0)

3DCC	ED5F		STAT R5, $D
3DCE	1D01		CTRL $D, #$01
3DD0	8101		LBI R1, #$01
3DD2	C515		SBS R5, R1
3DD4	A003		BRA $3DDA		; $04(R0)

3DD6	8622		LBI R6, #$22
3DD8	A035		BRA $3E10		; $36(R0)
...
3DEA	A007		BRA $3DF4		; $08(R0)

3DEC	272A		MOVE R7, $54
3DEE	C704		SS R7
3DF0	F00D		BRA $3DE4		; -> -$0E(R0)
...
3DF6	ED5F		STAT R5, $D
3DF8	C516		SBC R5, R1
3DFA	F02D		BRA $3DCE		; -> -$2E(R0)

3DFC	1D01		CTRL $D, #$01
3DFE	2551		MOVE R5, $A2
3E00	8180		LBI R1, #$80
3E02	C51F		SNBSH R5, R1
3E04	A007		BRA $3E0E		; $08(R0)

3E06	254A		MOVE R5, $94
3E08	8109		LBI R1, #$09
3E0A	C519		SGE R5, R1
3E0C	F02F		BRA $3DDE		; -> -$30(R0)

3E0E	8636		LBI R6, #$36
3E10	0203		INC2 R2, R0
3E12	A0E5		BRA $3EFA		; $E6(R0)

3E14	8638		LBI R6, #$38
3E16	1D01		CTRL $D, #$01
3E18	F009		BRA $3E10		; -> -$0A(R0)

3E1A	8907		LBI R9, #$07
3E1C	099D		MLH R9, R9
3E1E	893E		LBI R9, #$3E
3E20	3424		MOVE $48, R4
3E22	3626		MOVE $4C, R6
...
3E32	3F2F		MOVE $5E, R15
3E34	2850		MOVE R8, $A0
3E36	382A		MOVE $54, R8
3E38	1D80		CTRL $D, #$80
3E3A	F900		SUB R9, #$01
3E3C	8180		LBI R1, #$80
3E3E	C91F		SNBSH R9, R1
3E40	A013		BRA $3E56		; $14(R0)

3E42	272A		MOVE R7, $54
3E44	C704		SS R7
3E46	F00D		BRA $3E3A		; -> -$0E(R0)

3E48	ED5F		STAT R5, $D
3E4A	8101		LBI R1, #$01
3E4C	C515		SBS R5, R1
3E4E	A013		BRA $3E64		; $14(R0)

3E50	1D01		CTRL $D, #$01
3E52	8622		LBI R6, #$22
3E54	F045		BRA $3E10		; -> -$46(R0)

3E56	8101		LBI R1, #$01
3E58	ED5F		STAT R5, $D
3E5A	C516		SBC R5, R1
3E5C	F00D		BRA $3E50		; -> -$0E(R0)

3E5E	1D01		CTRL $D, #$01
3E60	8634		LBI R6, #$34
3E62	F053		BRA $3E10		; -> -$54(R0)

3E64	8108		LBI R1, #$08
3E66	C515		SBS R5, R1
3E68	A003		BRA $3E6E		; $04(R0)

3E6A	144A		CTRL $4, #$4A
3E6C	0024		RET R2

3E6E	861E		LBI R6, #$1E
3E70	F061		BRA $3E10		; -> -$62(R0)
...
3E80	F700		SUB R7, #$01
3E82	C703		SZ R7
3E84	F007		BRA $3E7E		; -> -$08(R0)

3E86	1D02		CTRL $D, #$02
3E88	85A1		LBI R5, #$A1
3E8A	884B		LBI R8, #$4B
3E8C	4D88		PUTB $D, (R8)
3E8E	F000		BRA $3E8F		; -> -$01(R0)

3E90	F000		BRA $3E91		; -> -$01(R0)

3E92	4D88		PUTB $D, (R8)
3E94	F000		BRA $3E95		; -> -$01(R0)

3E96	F000		BRA $3E97		; -> -$01(R0)

3E98	4D88		PUTB $D, (R8)
3E9A	F000		BRA $3E9B		; -> -$01(R0)

3E9C	1D08		CTRL $D, #$08
3E9E	884D		LBI R8, #$4D
3EA0	4D88		PUTB $D, (R8)
3EA2	F000		BRA $3EA3		; -> -$01(R0)
...
3EB0	F009		BRA $3EA8		; -> -$0A(R0)

3EB2	1D0C		CTRL $D, #$0C
3EB4	0004		NOP
3EB6	4D48		PUTB $D, (R4)
3EB8	F000		BRA $3EB9		; -> -$01(R0)

3EBA	1D0C		CTRL $D, #$0C
3EBC	F000		BRA $3EBD		; -> -$01(R0)

3EBE	4D48		PUTB $D, (R4)
3EC0	2450		MOVE R4, $A0
3EC2	845E		LBI R4, #$5E
3EC4	1D08		CTRL $D, #$08
3EC6	F000		BRA $3EC7		; -> -$01(R0)

3EC8	4D48		PUTB $D, (R4)
3ECA	0004		NOP
3ECC	8AFF		LBI R10, #$FF
3ECE	1447		CTRL $4, #$47
3ED0	F000		BRA $3ED1		; -> -$01(R0)

3ED2	F000		BRA $3ED3		; -> -$01(R0)
...
3EE8	0004		NOP
3EEA	C703		SZ R7
3EEC	F009		BRA $3EE4		; -> -$0A(R0)

3EEE	1D02		CTRL $D, #$02
3EF0	884D		LBI R8, #$4D
3EF2	4D88		PUTB $D, (R8)
3EF4	F000		BRA $3EF5		; -> -$01(R0)

3EF6	1D08		CTRL $D, #$08
3EF8	F055		BRA $3EA4		; -> -$56(R0)

3EFA	3240		MOVE $80, R2
3EFC	144A		CTRL $4, #$4A
3EFE	87F0		LBI R7, #$F0
3F00	077D		MLH R7, R7
3F02	0068		ADD R0, R6
...
3F68	A40B		ADD R4, #$0C
3F6A	5748		MOVE (R4), R7
3F6C	0433		INC2 R4, R3
3F6E	6548		MOVB R5, (R4)
3F70	8140		LBI R1, #$40
3F72	C612		SE R6, R1
3F74	A015		BRA $3F8C		; $16(R0)

3F76	8100		LBI R1, #$00
3F78	C51A		SNE R5, R1
3F7A	A00B		BRA $3F88		; $0C(R0)

3F7C	8104		LBI R1, #$04
3F7E	C51A		SNE R5, R1
3F80	A005		BRA $3F88		; $06(R0)

3F82	8105		LBI R1, #$05
3F84	C512		SE R5, R1
3F86	A003		BRA $3F8C		; $04(R0)

3F88	8644		LBI R6, #$44
3F8A	F08D		BRA $3EFE		; -> -$8E(R0)

3F8C	8134		LBI R1, #$34
3F8E	C619		SGE R6, R1
3F90	A00F		BRA $3FA2		; $10(R0)
...
3FA2	8116		LBI R1, #$16
3FA4	C612		SE R6, R1
3FA6	A00D		BRA $3FB6		; $0E(R0)

3FA8	8105		LBI R1, #$05
3FAA	C512		SE R5, R1
3FAC	A007		BRA $3FB6		; $08(R0)
...
3FB6	8160		LBI R1, #$60
3FB8	C61A		SNE R6, R1
3FBA	A011		BRA $3FCE		; $12(R0)

3FBC	8108		LBI R1, #$08
3FBE	C61A		SNE R6, R1
3FC0	A00B		BRA $3FCE		; $0C(R0)

3FC2	8122		LBI R1, #$22
3FC4	C610		SLE R6, R1
3FC6	A011		BRA $3FDA		; $12(R0)

3FC8	811C		LBI R1, #$1C
3FCA	C619		SGE R6, R1
3FCC	A00B		BRA $3FDA		; $0C(R0)
...
3FFE	F019		BRA $3FE6		; -> -$1A(R0)

4000	246C		MOVE R4, $D8
4002	D548		MOVE R5, (R4)
4004	065C		MHL R6, R5
4006	0656		OR R6, R5
4008	C603		SZ R6
400A	A007		BRA $4014		; $08(R0)
...
4076	1102		CTRL $1, #$02
4078	144A		CTRL $4, #$4A
407A	325B		MOVE $B6, R2
407C	0D34		MOVE R13, R3
407E	8101		LBI R1, #$01
4080	C417		SBSH R4, R1
4082	A031		BRA $40B6		; $32(R0)

4084	1077		CTRL $0, #$77
4086	8102		LBI R1, #$02
4088	C41F		SNBSH R4, R1
408A	A02B		BRA $40B8		; $2C(R0)

408C	2451		MOVE R4, $A2
408E	8110		LBI R1, #$10
4090	C415		SBS R4, R1
4092	A023		BRA $40B8		; $24(R0)
...
40AC	5251		MOVE (R5)+, R2
40AE	5358		MOVE (R5), R3
40B0	287E		MOVE R8, $FC
40B2	0203		INC2 R2, R0
40B4	2056		JMP ($00AC)

40B6	106F		CTRL $0, #$6F
40B8	0D34		MOVE R13, R3
40BA	AD0B		ADD R13, #$0C
40BC	2450		MOVE R4, $A0
40BE	54D8		MOVE (R13), R4
40C0	FD0B		SUB R13, #$0C
40C2	64D8		MOVB R4, (R13)
40C4	81F0		LBI R1, #$F0
40C6	C416		SBC R4, R1
40C8	A021		BRA $40EC		; $22(R0)
...
40E8	064C		MHL R6, R4
40EA	C60B		SNZ R6
40EC	A0E1		BRA $41D0		; $E2(R0)

40EE	2804		MOVE R8, $08
...
414E	0D34		MOVE R13, R3
4150	AD0F		ADD R13, #$10
4152	D4D8		MOVE R4, (R13)
4154	FD0F		SUB R13, #$10
4156	850C		LBI R5, #$0C
4158	C45E		SNBC R4, R5
415A	A069		BRA $41C6		; $6A(R0)

415C	8104		LBI R1, #$04
415E	C415		SBS R4, R1
4160	A069		BRA $41CC		; $6A(R0)
...
4172	C655		SBS R6, R5
4174	A015		BRA $418C		; $16(R0)

4176	81FF		LBI R1, #$FF
4178	F900		SUB R9, #$01
417A	C917		SBSH R9, R1
417C	F00D		BRA $4170		; -> -$0E(R0)

417E	F700		SUB R7, #$01
4180	0A7C		MHL R10, R7
4182	CA03		SZ R10
4184	F01B		BRA $416A		; -> -$1C(R0)

4186	C703		SZ R7
4188	F01F		BRA $416A		; -> -$20(R0)

418A	A02D		BRA $41BA		; $2E(R0)

418C	8102		LBI R1, #$02
418E	C415		SBS R4, R1
4190	A033		BRA $41C6		; $34(R0)
...
41BC	066D		MLH R6, R6
41BE	86F0		LBI R6, #$F0
41C0	AD0B		ADD R13, #$0C
41C2	56D8		MOVE (R13), R6
41C4	A001		BRA $41C8		; $02(R0)
...
41D2	066D		MLH R6, R6
41D4	86F3		LBI R6, #$F3
41D6	AD0B		ADD R13, #$0C
41D8	56D8		MOVE (R13), R6
41DA	F0DF		BRA $40FC		; -> -$E0(R0)

41DC	3259		MOVE $B2, R2
41DE	1443		CTRL $4, #$43
41E0	0D34		MOVE R13, R3
41E2	D4D1		MOVE R4, (R13)+
41E4	64D0		MOVB R4, (R13)+
41E6	94F0		CLR R4, #$F0
41E8	66D6		MOVB R6, (R13)---
41EA	96F0		CLR R6, #$F0
41EC	0448		ADD R4, R4
41EE	0048		ADD R0, R4
41F0	A0AF		BRA $42A2		; $B0(R0)

41F2	A02F		BRA $4224		; $30(R0)

41F4	A077		BRA $426E		; $78(R0)

41F6	A03B		BRA $4234		; $3C(R0)

41F8	A015		BRA $4210		; $16(R0)

41FA	A0C7		BRA $42C4		; $C8(R0)

41FC	A0C9		BRA $42C8		; $CA(R0)

41FE	A0CB		BRA $42CC		; $CC(R0)

4200	A0DD		BRA $42E0		; $DE(R0)

4202	A0B1		BRA $42B6		; $B2(R0)

4204	A0AF		BRA $42B6		; $B0(R0)

4206	A0AD		BRA $42B6		; $AE(R0)

4208	A0AB		BRA $42B6		; $AC(R0)

420A	A0A9		BRA $42B6		; $AA(R0)

420C	A0A7		BRA $42B6		; $A8(R0)

420E	A0A5		BRA $42B6		; $A6(R0)
...
4220	F005		BRA $421C		; -> -$06(R0)

4222	A08B		BRA $42B0		; $8C(R0)
...
4240	F600		SUB R6, #$01
4242	C604		SS R6
4244	F007		BRA $423E		; -> -$08(R0)

4246	0654		MOVE R6, R5
4248	F63F		SUB R6, #$40
424A	F400		SUB R4, #$01
424C	C40B		SNZ R4
424E	A00D		BRA $425E		; $0E(R0)

4250	8720		LBI R7, #$20
4252	D165		MOVE R1, (R6)-
4254	5155		MOVE (R5)-, R1
4256	F700		SUB R7, #$01
4258	C703		SZ R7
425A	F009		BRA $4252		; -> -$0A(R0)

425C	F013		BRA $424A		; -> -$14(R0)
...
4266	F700		SUB R7, #$01
4268	C703		SZ R7
426A	F007		BRA $4264		; -> -$08(R0)

426C	A033		BRA $42A2		; $34(R0)
...
427A	8440		LBI R4, #$40
427C	C61A		SNE R6, R1
427E	A015		BRA $4296		; $16(R0)

4280	8720		LBI R7, #$20
4282	D141		MOVE R1, (R4)+
4284	5151		MOVE (R5)+, R1
4286	F700		SUB R7, #$01
4288	C703		SZ R7
428A	F009		BRA $4282		; -> -$0A(R0)

428C	A600		ADD R6, #$01
428E	810F		LBI R1, #$0F
4290	C612		SE R6, R1
4292	F013		BRA $4280		; -> -$14(R0)
...
42BE	AD0B		ADD R13, #$0C
42C0	54D8		MOVE (R13), R4
42C2	F021		BRA $42A2		; -> -$22(R0)

42C4	107E		CTRL $0, #$7E
42C6	F017		BRA $42B0		; -> -$18(R0)

42C8	107D		CTRL $0, #$7D
42CA	F01B		BRA $42B0		; -> -$1C(R0)
...
42DA	F007		BRA $42D4		; -> -$08(R0)

42DC	107D		CTRL $0, #$7D
42DE	F02F		BRA $42B0		; -> -$30(R0)
...
4324	0004		NOP
4326	F077		BRA $42B0		; -> -$78(R0)

4328	0D34		MOVE R13, R3
432A	AD0F		ADD R13, #$10
432C	D5D8		MOVE R5, (R13)
432E	9504		CLR R5, #$04
4330	55D8		MOVE (R13), R5
4332	F083		BRA $42B0		; -> -$84(R0)

4334	1077		CTRL $0, #$77
4336	325A		MOVE $B4, R2
4338	0D34		MOVE R13, R3
433A	AD01		ADD R13, #$02
433C	64D5		MOVB R4, (R13)--
433E	8101		LBI R1, #$01
4340	C41A		SNE R4, R1
4342	A039		BRA $437E		; $3A(R0)
...
43A4	0D34		MOVE R13, R3
43A6	AD00		ADD R13, #$01
43A8	64D4		MOVB R4, (R13)-
43AA	8180		LBI R1, #$80
43AC	C412		SE R4, R1
43AE	A047		BRA $43F8		; $48(R0)

43B0	AD03		ADD R13, #$04
43B2	D4D4		MOVE R4, (R13)~
43B4	6648		MOVB R6, (R4)
43B6	8140		LBI R1, #$40
43B8	C612		SE R6, R1
43BA	A003		BRA $43C0		; $04(R0)

43BC	876D		LBI R7, #$6D
43BE	A001		BRA $43C2		; $02(R0)
...
49FC	0000		HALT
49FE	0000		HALT
4A00	3269		MOVE $D2, R2
4A02	0D33		INC2 R13, R3
4A04	6ED8		MOVB R14, (R13)
4A06	8FE0		LBI R15, #$E0
4A08	AD0D		ADD R13, #$0E
4A0A	6CD8		MOVB R12, (R13)
4A0C	8948		LBI R9, #$48
4A0E	CE0B		SNZ R14
4A10	0C94		MOVE R12, R9
4A12	CC92		SE R12, R9
4A14	A0B9		BRA $4AD0		; $BA(R0)

4A16	7CD0		MOVB (R13)+, R12
4A18	6CD8		MOVB R12, (R13)
4A1A	8924		LBI R9, #$24
4A1C	CE0B		SNZ R14
4A1E	0C94		MOVE R12, R9
4A20	CC92		SE R12, R9
4A22	A0AB		BRA $4AD0		; $AC(R0)

4A24	7CD8		MOVB (R13), R12
4A26	CE03		SZ R14
4A28	A03B		BRA $4A66		; $3C(R0)
...
4A4E	5ED3		MOVE (R13)++, R14
4A50	1F10		CTRL $F, #$10
4A52	2D23		MOVE R13, $46
...
4A68	05AE		GETB R10, $5
4A6A	CA0C		SNS R10
4A6C	A061		BRA $4AD0		; $62(R0)
...
4B88	CD03		SZ R13
4B8A	CE0C		SNS R14
4B8C	A001		BRA $4B90		; $02(R0)

4B8E	F011		BRA $4B7E		; -> -$12(R0)
...
4BA2	8184		LBI R1, #$84
4BA4	51D8		MOVE (R13), R1
4BA6	AD03		ADD R13, #$04
4BA8	2150		MOVE R1, $A0
4BAA	51D8		MOVE (R13), R1
...
6040	65E8		MOVB R5, (R14)
6042	810E		LBI R1, #$0E
6044	C152		SE R1, R5
6046	A013		BRA $605C		; $14(R0)

6048	2E40		MOVE R14, $80
604A	AE02		ADD R14, #$03
604C	65E8		MOVB R5, (R14)
604E	C50B		SNZ R5
6050	A0FB		BRA $614E		; $FC(R0)

6052	A00F		BRA $6064		; $10(R0)
...
6066	AE0A		ADD R14, #$0B
6068	D5E8		MOVE R5, (R14)
606A	055C		MHL R5, R5
606C	C50B		SNZ R5
606E	F013		BRA $605C		; -> -$14(R0)
...
6120	65E8		MOVB R5, (R14)
6122	2E41		MOVE R14, $82
6124	AE0E		ADD R14, #$0F
6126	55E8		MOVE (R14), R5
...
61E2	65E8		MOVB R5, (R14)
61E4	8180		LBI R1, #$80
61E6	C51E		SNBC R5, R1
61E8	A00B		BRA $61F6		; $0C(R0)
...
61FA	65E8		MOVB R5, (R14)
61FC	810D		LBI R1, #$0D
61FE	C510		SLE R5, R1
6200	A0DB		BRA $62DE		; $DC(R0)

6202	F500		SUB R5, #$01
6204	0558		ADD R5, R5
6206	2E41		MOVE R14, $82
6208	AE0E		ADD R14, #$0F
620A	D6E8		MOVE R6, (R14)
620C	810B		LBI R1, #$0B
620E	C610		SLE R6, R1
6210	A0CB		BRA $62DE		; $CC(R0)

6212	0668		ADD R6, R6
6214	0058		ADD R0, R5
6216	A013		BRA $622C		; $14(R0)

6218	A02B		BRA $6246		; $2C(R0)

621A	A029		BRA $6246		; $2A(R0)

621C	A041		BRA $6260		; $42(R0)

621E	A041		BRA $6262		; $42(R0)

6220	A059		BRA $627C		; $5A(R0)

6222	A065		BRA $628A		; $66(R0)

6224	A065		BRA $628C		; $66(R0)

6226	A07D		BRA $62A6		; $7E(R0)

6228	A095		BRA $62C0		; $96(R0)

622A	A095		BRA $62C2		; $96(R0)

622C	0068		ADD R0, R6
622E	A0AD		BRA $62DE		; $AE(R0)

6230	A0C3		BRA $62F6		; $C4(R0)

6232	A0C1		BRA $62F6		; $C2(R0)

6234	A0BF		BRA $62F6		; $C0(R0)

6236	A0BD		BRA $62F6		; $BE(R0)

6238	A0A3		BRA $62DE		; $A4(R0)

623A	A0A1		BRA $62DE		; $A2(R0)

623C	A09F		BRA $62DE		; $A0(R0)

623E	A0B5		BRA $62F6		; $B6(R0)

6240	A0B3		BRA $62F6		; $B4(R0)

6242	A0B1		BRA $62F6		; $B2(R0)

6244	A097		BRA $62DE		; $98(R0)

6246	0068		ADD R0, R6
6248	A093		BRA $62DE		; $94(R0)

624A	A09D		BRA $62EA		; $9E(R0)

624C	A09B		BRA $62EA		; $9C(R0)

624E	A099		BRA $62EA		; $9A(R0)

6250	A097		BRA $62EA		; $98(R0)

6252	A089		BRA $62DE		; $8A(R0)

6254	A087		BRA $62DE		; $88(R0)

6256	A085		BRA $62DE		; $86(R0)

6258	A08F		BRA $62EA		; $90(R0)

625A	A08D		BRA $62EA		; $8E(R0)

625C	A08B		BRA $62EA		; $8C(R0)

625E	A089		BRA $62EA		; $8A(R0)

6260	A0DB		BRA $633E		; $DC(R0)

6262	0068		ADD R0, R6
6264	A077		BRA $62DE		; $78(R0)

6266	A075		BRA $62DE		; $76(R0)

6268	A073		BRA $62DE		; $74(R0)

626A	A071		BRA $62DE		; $72(R0)

626C	A07B		BRA $62EA		; $7C(R0)

626E	A079		BRA $62EA		; $7A(R0)

6270	A077		BRA $62EA		; $78(R0)

6272	A069		BRA $62DE		; $6A(R0)

6274	A067		BRA $62DE		; $68(R0)

6276	A065		BRA $62DE		; $66(R0)

6278	A06F		BRA $62EA		; $70(R0)

627A	A061		BRA $62DE		; $62(R0)
...
628C	0068		ADD R0, R6
628E	A04D		BRA $62DE		; $4E(R0)

6290	A063		BRA $62F6		; $64(R0)

6292	A049		BRA $62DE		; $4A(R0)

6294	A047		BRA $62DE		; $48(R0)

6296	A05D		BRA $62F6		; $5E(R0)

6298	A043		BRA $62DE		; $44(R0)

629A	A041		BRA $62DE		; $42(R0)

629C	A03F		BRA $62DE		; $40(R0)

629E	A055		BRA $62F6		; $56(R0)

62A0	A03B		BRA $62DE		; $3C(R0)

62A2	A051		BRA $62F6		; $52(R0)

62A4	A04F		BRA $62F6		; $50(R0)

62A6	0068		ADD R0, R6
62A8	A033		BRA $62DE		; $34(R0)

62AA	A049		BRA $62F6		; $4A(R0)

62AC	A047		BRA $62F6		; $48(R0)

62AE	A045		BRA $62F6		; $46(R0)

62B0	A02B		BRA $62DE		; $2C(R0)

62B2	A029		BRA $62DE		; $2A(R0)

62B4	A027		BRA $62DE		; $28(R0)

62B6	A025		BRA $62DE		; $26(R0)

62B8	A03B		BRA $62F6		; $3C(R0)

62BA	A039		BRA $62F6		; $3A(R0)

62BC	A01F		BRA $62DE		; $20(R0)

62BE	A01D		BRA $62DE		; $1E(R0)

62C0	A07B		BRA $633E		; $7C(R0)

62C2	0068		ADD R0, R6
62C4	A017		BRA $62DE		; $18(R0)

62C6	A015		BRA $62DE		; $16(R0)

62C8	A013		BRA $62DE		; $14(R0)

62CA	A011		BRA $62DE		; $12(R0)

62CC	A01B		BRA $62EA		; $1C(R0)

62CE	A00D		BRA $62DE		; $0E(R0)

62D0	A00B		BRA $62DE		; $0C(R0)

62D2	A009		BRA $62DE		; $0A(R0)

62D4	A007		BRA $62DE		; $08(R0)

62D6	A005		BRA $62DE		; $06(R0)

62D8	A00F		BRA $62EA		; $10(R0)

62DA	A001		BRA $62DE		; $02(R0)
...
62F0	8115		LBI R1, #$15
62F2	C512		SE R5, R1
62F4	F011		BRA $62E4		; -> -$12(R0)

62F6	2676		MOVE R6, $EC
62F8	016C		MHL R1, R6
62FA	0166		OR R1, R6
62FC	C10B		SNZ R1
62FE	F021		BRA $62DE		; -> -$22(R0)

6300	2E40		MOVE R14, $80
6302	AE02		ADD R14, #$03
6304	65E8		MOVB R5, (R14)
6306	2679		MOVE R6, $F2
6308	0558		ADD R5, R5
630A	0058		ADD R0, R5
630C	0000		HALT
630E	A013		BRA $6324		; $14(R0)

6310	A011		BRA $6324		; $12(R0)

6312	A00F		BRA $6324		; $10(R0)

6314	0000		HALT
6316	A025		BRA $633E		; $26(R0)

6318	0000		HALT
631A	0000		HALT
631C	A017		BRA $6336		; $18(R0)

631E	A015		BRA $6336		; $16(R0)

6320	0000		HALT
6322	A015		BRA $633A		; $16(R0)

6324	2E40		MOVE R14, $80
6326	AE06		ADD R14, #$07
6328	D5E8		MOVE R5, (R14)
632A	C503		SZ R5
632C	F04F		BRA $62DE		; -> -$50(R0)

632E	8E02		LBI R14, #$02
6330	055C		MHL R5, R5
6332	C5E2		SE R5, R14
6334	F057		BRA $62DE		; -> -$58(R0)

6336	C60B		SNZ R6
6338	F05B		BRA $62DE		; -> -$5C(R0)

633A	C60C		SNS R6
633C	A0AB		BRA $63EA		; $AC(R0)

633E	2E40		MOVE R14, $80
6340	AE02		ADD R14, #$03
...
6416	8142		LBI R1, #$42
6418	C15A		SNE R1, R5
641A	A017		BRA $6434		; $18(R0)

641C	8124		LBI R1, #$24
641E	C152		SE R1, R5
6420	A029		BRA $644C		; $2A(R0)

6422	2E40		MOVE R14, $80
6424	AE03		ADD R14, #$04
6426	65E8		MOVB R5, (R14)
6428	8108		LBI R1, #$08
642A	C515		SBS R5, R1
642C	F025		BRA $6408		; -> -$26(R0)
...
6480	D0F5		JMP (R15)-
6482	A001		BRA $6486		; $02(R0)

6484	A0AF		BRA $6536		; $B0(R0)

6486	2E40		MOVE R14, $80
6488	AE03		ADD R14, #$04
648A	65E8		MOVB R5, (R14)
648C	8108		LBI R1, #$08
648E	C516		SBC R5, R1
6490	A0A3		BRA $6536		; $A4(R0)

6492	F03F		BRA $6454		; -> -$40(R0)
...
6514	D0F5		JMP (R15)-
6516	A001		BRA $651A		; $02(R0)

6518	A01B		BRA $6536		; $1C(R0)
...
6520	8108		LBI R1, #$08
6522	C516		SBC R5, R1
6524	A00F		BRA $6536		; $10(R0)

6526	F05F		BRA $64C8		; -> -$60(R0)
...
653C	2574		MOVE R5, $E8
653E	015C		MHL R1, R5
6540	0156		OR R1, R5
6542	C10B		SNZ R1
6544	A01B		BRA $6562		; $1C(R0)

6546	8180		LBI R1, #$80
6548	C51F		SNBSH R5, R1
654A	A015		BRA $6562		; $16(R0)

654C	2574		MOVE R5, $E8
654E	2E41		MOVE R14, $82
6550	AE00		ADD R14, #$01
6552	55E8		MOVE (R14), R5
6554	8169		LBI R1, #$69
6556	011D		MLH R1, R1
6558	81D6		LBI R1, #$D6
...
6586	0156		OR R1, R5
6588	C10B		SNZ R1
658A	A005		BRA $6592		; $06(R0)

658C	065C		MHL R6, R5
658E	963F		CLR R6, #$3F
6590	C603		SZ R6
6592	A0DF		BRA $6674		; $E0(R0)

6594	3578		MOVE $F0, R5
6596	2E40		MOVE R14, $80
6598	AE0E		ADD R14, #$0F
659A	D5E8		MOVE R5, (R14)
659C	015C		MHL R1, R5
659E	0156		OR R1, R5
65A0	C10B		SNZ R1
65A2	A0CF		BRA $6674		; $D0(R0)

65A4	8180		LBI R1, #$80
65A6	C51F		SNBSH R5, R1
65A8	A0C9		BRA $6674		; $CA(R0)

65AA	2E40		MOVE R14, $80
65AC	AE02		ADD R14, #$03
65AE	67E8		MOVB R7, (R14)
65B0	8106		LBI R1, #$06
65B2	C17A		SNE R1, R7
65B4	A011		BRA $65C8		; $12(R0)
...
6776	A00D		BRA $6786		; $0E(R0)

6778	A005		BRA $6780		; $06(R0)
...
696E	8101		LBI R1, #$01
6970	C16A		SNE R1, R6
6972	A05B		BRA $69D0		; $5C(R0)

6974	015C		MHL R1, R5
6976	0156		OR R1, R5
6978	C103		SZ R1
697A	A04D		BRA $69CA		; $4E(R0)

697C	2574		MOVE R5, $E8
697E	A500		ADD R5, #$01
6980	2677		MOVE R6, $EE
6982	0569		SUB R5, R6
6984	065C		MHL R6, R5
6986	055D		MLH R5, R5
6988	056C		MHL R5, R6
...
6992	0156		OR R1, R5
6994	C10B		SNZ R1
6996	A02D		BRA $69C6		; $2E(R0)

6998	8180		LBI R1, #$80
699A	C51F		SNBSH R5, R1
699C	A019		BRA $69B8		; $1A(R0)
...
69DC	A003		BRA $69E2		; $04(R0)

69DE	8502		LBI R5, #$02
69E0	A001		BRA $69E4		; $02(R0)
...
6A3C	0166		OR R1, R6
6A3E	C10B		SNZ R1
6A40	A02D		BRA $6A70		; $2E(R0)

6A42	8180		LBI R1, #$80
6A44	C61F		SNBSH R6, R1
6A46	F04B		BRA $69FC		; -> -$4C(R0)
...
6BF0	055C		MHL R5, R5
6BF2	C50B		SNZ R5
6BF4	A07D		BRA $6C74		; $7E(R0)

6BF6	2577		MOVE R5, $EE
6BF8	015C		MHL R1, R5
6BFA	0156		OR R1, R5
6BFC	C10B		SNZ R1
6BFE	A03D		BRA $6C3E		; $3E(R0)

6C00	2646		MOVE R6, $8C
6C02	016C		MHL R1, R6
6C04	0166		OR R1, R6
6C06	C10B		SNZ R1
6C08	A045		BRA $6C50		; $46(R0)
...
6C80	A007		BRA $6C8A		; $08(R0)

6C82	8501		LBI R5, #$01
6C84	055D		MLH R5, R5
6C86	8501		LBI R5, #$01
6C88	A005		BRA $6C90		; $06(R0)

6C8A	8507		LBI R5, #$07
6C8C	055D		MLH R5, R5
6C8E	850A		LBI R5, #$0A
6C90	357A		MOVE $F4, R5
6C92	2578		MOVE R5, $F0
...
6D76	055C		MHL R5, R5
6D78	C50B		SNZ R5
6D7A	A08B		BRA $6E08		; $8C(R0)

6D7C	2577		MOVE R5, $EE
6D7E	015C		MHL R1, R5
6D80	0156		OR R1, R5
6D82	C10B		SNZ R1
6D84	A045		BRA $6DCC		; $46(R0)

6D86	2646		MOVE R6, $8C
6D88	016C		MHL R1, R6
6D8A	0166		OR R1, R6
6D8C	C10B		SNZ R1
6D8E	A04D		BRA $6DDE		; $4E(R0)
...
6E14	A003		BRA $6E1A		; $04(R0)

6E16	8501		LBI R5, #$01
6E18	A001		BRA $6E1C		; $02(R0)
...
6E3A	CE03		SZ R14
6E3C	A005		BRA $6E44		; $06(R0)

6E3E	0EEC		MHL R14, R14
6E40	9EFF		CLR R14, #$FF
6E42	CE03		SZ R14
6E44	A029		BRA $6E70		; $2A(R0)

6E46	2543		MOVE R5, $86
6E48	8181		LBI R1, #$81
6E4A	C152		SE R1, R5
6E4C	A017		BRA $6E66		; $18(R0)

6E4E	2577		MOVE R5, $EE
6E50	F500		SUB R5, #$01
6E52	015C		MHL R1, R5
6E54	0156		OR R1, R5
6E56	C10B		SNZ R1
6E58	A00B		BRA $6E66		; $0C(R0)
...
6E84	D0F5		JMP (R15)-
6E86	F05D		BRA $6E2A		; -> -$5E(R0)

6E88	8107		LBI R1, #$07
6E8A	3048		MOVE $90, R0
6E8C	204E		JMP ($009C)

6E8E	2576		MOVE R5, $EC
6E90	015C		MHL R1, R5
6E92	0156		OR R1, R5
6E94	C10B		SNZ R1
6E96	A00B		BRA $6EA4		; $0C(R0)

6E98	8180		LBI R1, #$80
6E9A	C51F		SNBSH R5, R1
6E9C	A005		BRA $6EA4		; $06(R0)

6E9E	2579		MOVE R5, $F2
6EA0	C50C		SNS R5
6EA2	A0B9		BRA $6F5E		; $BA(R0)

6EA4	2551		MOVE R5, $A2
6EA6	8180		LBI R1, #$80
6EA8	C517		SBSH R5, R1
6EAA	A003		BRA $6EB0		; $04(R0)

6EAC	8501		LBI R5, #$01
6EAE	A001		BRA $6EB2		; $02(R0)
...
6F68	0156		OR R1, R5
6F6A	C103		SZ R1
6F6C	F0DF		BRA $6E8E		; -> -$E0(R0)

6F6E	257A		MOVE R5, $F4
6F70	F500		SUB R5, #$01
6F72	357A		MOVE $F4, R5
6F74	C50B		SNZ R5
6F76	A00D		BRA $6F86		; $0E(R0)
...
6F98	A003		BRA $6F9E		; $04(R0)

6F9A	8501		LBI R5, #$01
6F9C	A001		BRA $6FA0		; $02(R0)
...
6FFA	A001		BRA $6FFE		; $02(R0)

6FFC	F05B		BRA $6FA2		; -> -$5C(R0)
...
709E	CE03		SZ R14
70A0	A005		BRA $70A8		; $06(R0)

70A2	0EEC		MHL R14, R14
70A4	9EFF		CLR R14, #$FF
70A6	CE03		SZ R14
70A8	A00B		BRA $70B6		; $0C(R0)
...
7190	A003		BRA $7196		; $04(R0)

7192	8502		LBI R5, #$02
7194	A001		BRA $7198		; $02(R0)
...
72C4	CE03		SZ R14
72C6	A007		BRA $72D0		; $08(R0)

72C8	0EEC		MHL R14, R14
72CA	9EDF		CLR R14, #$DF
72CC	CE0B		SNZ R14
72CE	F043		BRA $728C		; -> -$44(R0)

72D0	F0DB		BRA $71F6		; -> -$DC(R0)
...
7364	CE03		SZ R14
7366	A005		BRA $736E		; $06(R0)

7368	0EEC		MHL R14, R14
736A	9E7F		CLR R14, #$7F
736C	CE03		SZ R14
736E	A00D		BRA $737E		; $0E(R0)
...
748A	CE03		SZ R14
748C	A007		BRA $7496		; $08(R0)

748E	0EEC		MHL R14, R14
7490	9EBF		CLR R14, #$BF
7492	CE0B		SNZ R14
7494	A00D		BRA $74A4		; $0E(R0)
...
74A8	CE03		SZ R14
74AA	A007		BRA $74B4		; $08(R0)

74AC	0EEC		MHL R14, R14
74AE	9EFF		CLR R14, #$FF
74B0	CE0B		SNZ R14
74B2	A011		BRA $74C6		; $12(R0)
...
74BA	813D		LBI R1, #$3D
74BC	C512		SE R5, R1
74BE	A00B		BRA $74CC		; $0C(R0)

74C0	1EF3		CTRL $E, #$F3
74C2	D1F5		MOVE R1, (R15)-
74C4	0013		INC2 R0, R1
74C6	1EFF		CTRL $E, #$FF
74C8	D1F5		MOVE R1, (R15)-
74CA	0013		INC2 R0, R1
74CC	8100		LBI R1, #$00
...
7500	01B6		OR R1, R11
7502	C103		SZ R1
7504	F015		BRA $74F0		; -> -$16(R0)

7506	364F		MOVE $9E, R6
7508	D0F5		JMP (R15)-
750A	8579		LBI R5, #$79
750C	055D		MLH R5, R5
750E	854E		LBI R5, #$4E
7510	3520		MOVE $40, R5
7512	8510		LBI R5, #$10
7514	055D		MLH R5, R5
7516	8550		LBI R5, #$50
7518	352B		MOVE $56, R5
751A	8535		LBI R5, #$35
751C	3526		MOVE $4C, R5
751E	85E7		LBI R5, #$E7
7520	3527		MOVE $4E, R5
7522	8580		LBI R5, #$80
7524	3528		MOVE $50, R5
7526	8502		LBI R5, #$02
7528	3529		MOVE $52, R5
752A	8500		LBI R5, #$00
752C	055D		MLH R5, R5
752E	8553		LBI R5, #$53
7530	3522		MOVE $44, R5
7532	2550		MOVE R5, $A0
7534	352A		MOVE $54, R5
...
754A	8135		LBI R1, #$35
754C	C512		SE R5, R1
754E	A001		BRA $7552		; $02(R0)

7550	A007		BRA $755A		; $08(R0)
...
756A	CE03		SZ R14
756C	A007		BRA $7576		; $08(R0)

756E	0EEC		MHL R14, R14
7570	9E7F		CLR R14, #$7F
7572	CE0B		SNZ R14
7574	A005		BRA $757C		; $06(R0)

7576	0E5E		GETB R5, $E
7578	1E1E		CTRL $E, #$1E
757A	A003		BRA $7580		; $04(R0)
...
7596	8181		LBI R1, #$81
7598	C15A		SNE R1, R5
759A	A011		BRA $75AE		; $12(R0)

759C	8118		LBI R1, #$18
759E	C15A		SNE R1, R5
75A0	A00B		BRA $75AE		; $0C(R0)
...
7622	D0F5		JMP (R15)-
7624	FA00		SUB R10, #$01
7626	8180		LBI R1, #$80
7628	CA17		SBSH R10, R1
762A	F013		BRA $7618		; -> -$14(R0)

762C	8500		LBI R5, #$00
762E	055D		MLH R5, R5
7630	8520		LBI R5, #$20
7632	352B		MOVE $56, R5
7634	8579		LBI R5, #$79
7636	055D		MLH R5, R5
7638	8586		LBI R5, #$86
763A	3520		MOVE $40, R5
763C	8522		LBI R5, #$22
763E	8200		LBI R2, #$00
7640	022D		MLH R2, R2
7642	820B		LBI R2, #$0B
...
767A	CE03		SZ R14
767C	A005		BRA $7684		; $06(R0)

767E	0EEC		MHL R14, R14
7680	9EBF		CLR R14, #$BF
7682	CE03		SZ R14
7684	A011		BRA $7698		; $12(R0)
...
769C	CE03		SZ R14
769E	A005		BRA $76A6		; $06(R0)

76A0	0EEC		MHL R14, R14
76A2	9EBF		CLR R14, #$BF
76A4	CE03		SZ R14
76A6	A005		BRA $76AE		; $06(R0)
...
76BC	055D		MLH R5, R5
76BE	85AE		LBI R5, #$AE
76C0	3520		MOVE $40, R5
76C2	8500		LBI R5, #$00
76C4	055D		MLH R5, R5
76C6	8540		LBI R5, #$40
76C8	352B		MOVE $56, R5
76CA	8535		LBI R5, #$35
76CC	3526		MOVE $4C, R5
76CE	85E7		LBI R5, #$E7
76D0	3527		MOVE $4E, R5
76D2	8580		LBI R5, #$80
76D4	3528		MOVE $50, R5
76D6	8502		LBI R5, #$02
76D8	3529		MOVE $52, R5
76DA	8500		LBI R5, #$00
76DC	055D		MLH R5, R5
76DE	8553		LBI R5, #$53
76E0	3522		MOVE $44, R5
76E2	2550		MOVE R5, $A0
76E4	352A		MOVE $54, R5
...
7736	CE03		SZ R14
7738	A005		BRA $7740		; $06(R0)

773A	0EEC		MHL R14, R14
773C	9EFF		CLR R14, #$FF
773E	CE03		SZ R14
7740	A07B		BRA $77BE		; $7C(R0)
...
77D2	8135		LBI R1, #$35
77D4	C512		SE R5, R1
77D6	A023		BRA $77FC		; $24(R0)

77D8	252A		MOVE R5, $54
77DA	C50B		SNZ R5
77DC	A009		BRA $77E8		; $0A(R0)

77DE	2525		MOVE R5, $4A
77E0	8100		LBI R1, #$00
77E2	312A		MOVE $54, R1
77E4	D1F5		MOVE R1, (R15)-
77E6	0013		INC2 R0, R1
77E8	FC00		SUB R12, #$01
77EA	CC03		SZ R12
77EC	F023		BRA $77CA		; -> -$24(R0)

77EE	FB00		SUB R11, #$01
77F0	8180		LBI R1, #$80
77F2	CB17		SBSH R11, R1
77F4	F02B		BRA $77CA		; -> -$2C(R0)
...
7804	055D		MLH R5, R5
7806	851A		LBI R5, #$1A
7808	3520		MOVE $40, R5
780A	853D		LBI R5, #$3D
780C	3526		MOVE $4C, R5
780E	2577		MOVE R5, $EE
7810	3527		MOVE $4E, R5
7812	8580		LBI R5, #$80
7814	3528		MOVE $50, R5
7816	8502		LBI R5, #$02
7818	3529		MOVE $52, R5
781A	8500		LBI R5, #$00
781C	055D		MLH R5, R5
781E	854A		LBI R5, #$4A
7820	3522		MOVE $44, R5
7822	8500		LBI R5, #$00
7824	055D		MLH R5, R5
7826	85F9		LBI R5, #$F9
7828	352B		MOVE $56, R5
782A	8500		LBI R5, #$00
782C	055D		MLH R5, R5
782E	85AA		LBI R5, #$AA
7830	3525		MOVE $4A, R5
7832	8507		LBI R5, #$07
7834	352C		MOVE $58, R5
7836	0E1E		GETB R1, $E
7838	8540		LBI R5, #$40
783A	EE5F		STAT R5, $E
...
7858	8540		LBI R5, #$40
785A	EE5F		STAT R5, $E
785C	2628		MOVE R6, $50
785E	C60B		SNZ R6
7860	A013		BRA $7876		; $14(R0)

7862	813D		LBI R1, #$3D
7864	C512		SE R5, R1
7866	A011		BRA $787A		; $12(R0)

7868	FB00		SUB R11, #$01
786A	8180		LBI R1, #$80
786C	CB17		SBSH R11, R1
786E	F017		BRA $7858		; -> -$18(R0)
...
7882	055D		MLH R5, R5
7884	85F4		LBI R5, #$F4
7886	3520		MOVE $40, R5
7888	853D		LBI R5, #$3D
788A	3526		MOVE $4C, R5
788C	8580		LBI R5, #$80
788E	3528		MOVE $50, R5
7890	8502		LBI R5, #$02
7892	3529		MOVE $52, R5
7894	8500		LBI R5, #$00
7896	055D		MLH R5, R5
7898	854A		LBI R5, #$4A
789A	3522		MOVE $44, R5
789C	8501		LBI R5, #$01
789E	055D		MLH R5, R5
78A0	85FF		LBI R5, #$FF
78A2	352B		MOVE $56, R5
78A4	2E40		MOVE R14, $80
78A6	AE04		ADD R14, #$05
78A8	D5E8		MOVE R5, (R14)
78AA	3523		MOVE $46, R5
78AC	857A		LBI R5, #$7A
78AE	055D		MLH R5, R5
78B0	858E		LBI R5, #$8E
78B2	3524		MOVE $48, R5
78B4	2550		MOVE R5, $A0
78B6	3525		MOVE $4A, R5
78B8	8507		LBI R5, #$07
78BA	352C		MOVE $58, R5
78BC	0E1E		GETB R1, $E
78BE	8540		LBI R5, #$40
78C0	EE5F		STAT R5, $E
...
78FA	C60B		SNZ R6
78FC	A013		BRA $7912		; $14(R0)

78FE	813D		LBI R1, #$3D
7900	C512		SE R5, R1
7902	A011		BRA $7916		; $12(R0)

7904	FB00		SUB R11, #$01
7906	8180		LBI R1, #$80
7908	CB17		SBSH R11, R1
790A	F017		BRA $78F4		; -> -$18(R0)
...
7952	950A		CLR R5, #$0A
7954	C562		SE R5, R6
7956	A0AD		BRA $7A06		; $AE(R0)

7958	8580		LBI R5, #$80
795A	EE5F		STAT R5, $E
795C	C50B		SNZ R5
795E	A021		BRA $7982		; $22(R0)

7960	FB00		SUB R11, #$01
7962	CB8F		SNBSH R11, R8
7964	A03B		BRA $79A2		; $3C(R0)

7966	0E5E		GETB R5, $E
7968	F01B		BRA $794E		; -> -$1C(R0)

796A	8540		LBI R5, #$40
796C	EE5F		STAT R5, $E
796E	950A		CLR R5, #$0A
7970	C562		SE R5, R6
7972	A091		BRA $7A06		; $92(R0)

7974	8580		LBI R5, #$80
7976	EE5F		STAT R5, $E
7978	C57A		SNE R5, R7
797A	A069		BRA $79E6		; $6A(R0)

797C	FB00		SUB R11, #$01
797E	CB8F		SNBSH R11, R8
7980	A01F		BRA $79A2		; $20(R0)

7982	0E5E		GETB R5, $E
7984	F01B		BRA $796A		; -> -$1C(R0)
...
798C	950A		CLR R5, #$0A
798E	C562		SE R5, R6
7990	A073		BRA $7A06		; $74(R0)

7992	8580		LBI R5, #$80
7994	EE5F		STAT R5, $E
7996	C57A		SNE R5, R7
7998	A065		BRA $7A00		; $66(R0)

799A	FB00		SUB R11, #$01
799C	CB8F		SNBSH R11, R8
799E	A05F		BRA $7A00		; $60(R0)

79A0	F01B		BRA $7986		; -> -$1C(R0)
...
79B2	950A		CLR R5, #$0A
79B4	C562		SE R5, R6
79B6	A04D		BRA $7A06		; $4E(R0)

79B8	8580		LBI R5, #$80
79BA	EE5F		STAT R5, $E
79BC	C50B		SNZ R5
79BE	A021		BRA $79E2		; $22(R0)

79C0	FB00		SUB R11, #$01
79C2	CB8F		SNBSH R11, R8
79C4	A02D		BRA $79F4		; $2E(R0)

79C6	0E5E		GETB R5, $E
79C8	F01B		BRA $79AE		; -> -$1C(R0)

79CA	8540		LBI R5, #$40
79CC	EE5F		STAT R5, $E
79CE	950A		CLR R5, #$0A
79D0	C562		SE R5, R6
79D2	A031		BRA $7A06		; $32(R0)

79D4	8580		LBI R5, #$80
79D6	EE5F		STAT R5, $E
79D8	C57A		SNE R5, R7
79DA	A009		BRA $79E6		; $0A(R0)

79DC	FB00		SUB R11, #$01
79DE	CB8F		SNBSH R11, R8
79E0	A011		BRA $79F4		; $12(R0)

79E2	0E5E		GETB R5, $E
79E4	F01B		BRA $79CA		; -> -$1C(R0)
...
79EC	8580		LBI R5, #$80
79EE	EE5F		STAT R5, $E
79F0	8AFF		LBI R10, #$FF
79F2	F00B		BRA $79E8		; -> -$0C(R0)
...
7A00	8AFF		LBI R10, #$FF
7A02	0E1E		GETB R1, $E
7A04	F005		BRA $7A00		; -> -$06(R0)
...
7A14	8555		LBI R5, #$55
7A16	8C08		LBI R12, #$08
7A18	0E1E		GETB R1, $E
7A1A	8E40		LBI R14, #$40
7A1C	EEEF		STAT R14, $E
7A1E	CE62		SE R14, R6
7A20	A0E7		BRA $7B0A		; $E8(R0)
...
7A2A	CC03		SZ R12
7A2C	F015		BRA $7A18		; -> -$16(R0)

7A2E	FB00		SUB R11, #$01
7A30	CB87		SBSH R11, R8
7A32	F01F		BRA $7A14		; -> -$20(R0)

7A34	0403		INC2 R4, R0
7A36	A0B7		BRA $7AF0		; $B8(R0)

7A38	0403		INC2 R4, R0
7A3A	A0B3		BRA $7AF0		; $B4(R0)

7A3C	85E7		LBI R5, #$E7
7A3E	0403		INC2 R4, R0
7A40	A0AD		BRA $7AF0		; $AE(R0)

7A42	2543		MOVE R5, $86
7A44	0403		INC2 R4, R0
7A46	A0A7		BRA $7AF0		; $A8(R0)

7A48	057C		MHL R5, R7
7A4A	0403		INC2 R4, R0
7A4C	A0A1		BRA $7AF0		; $A2(R0)

7A4E	0574		MOVE R5, R7
7A50	0403		INC2 R4, R0
7A52	A09B		BRA $7AF0		; $9C(R0)

7A54	8B1D		LBI R11, #$1D
7A56	8C08		LBI R12, #$08
7A58	0E1E		GETB R1, $E
7A5A	8E40		LBI R14, #$40
7A5C	EEEF		STAT R14, $E
7A5E	CE62		SE R14, R6
7A60	A0A7		BRA $7B0A		; $A8(R0)
...
7A6A	CC03		SZ R12
7A6C	F015		BRA $7A58		; -> -$16(R0)

7A6E	FB00		SUB R11, #$01
7A70	CB03		SZ R11
7A72	F01D		BRA $7A56		; -> -$1E(R0)

7A74	2543		MOVE R5, $86
7A76	0403		INC2 R4, R0
7A78	A075		BRA $7AF0		; $76(R0)

7A7A	85E7		LBI R5, #$E7
7A7C	0403		INC2 R4, R0
7A7E	A06F		BRA $7AF0		; $70(R0)

7A80	0403		INC2 R4, R0
7A82	A06B		BRA $7AF0		; $6C(R0)

7A84	0403		INC2 R4, R0
7A86	A067		BRA $7AF0		; $68(R0)

7A88	0E1E		GETB R1, $E
7A8A	8800		LBI R8, #$00
7A8C	1E13		CTRL $E, #$13
7A8E	0403		INC2 R4, R0
7A90	A05D		BRA $7AF0		; $5E(R0)

7A92	85E7		LBI R5, #$E7
7A94	0403		INC2 R4, R0
7A96	A057		BRA $7AF0		; $58(R0)

7A98	2545		MOVE R5, $8A
7A9A	0403		INC2 R4, R0
7A9C	A051		BRA $7AF0		; $52(R0)

7A9E	6530		MOVB R5, (R3)+
7AA0	8C08		LBI R12, #$08
7AA2	0E1E		GETB R1, $E
7AA4	8E40		LBI R14, #$40
7AA6	EEEF		STAT R14, $E
7AA8	CE62		SE R14, R6
7AAA	A05D		BRA $7B0A		; $5E(R0)
...
7AEC	8800		LBI R8, #$00
7AEE	1E13		CTRL $E, #$13
7AF0	8C08		LBI R12, #$08
7AF2	0E1E		GETB R1, $E
7AF4	8E40		LBI R14, #$40
7AF6	EEEF		STAT R14, $E
7AF8	CE62		SE R14, R6
7AFA	A00D		BRA $7B0A		; $0E(R0)
...
7B04	CC03		SZ R12
7B06	F015		BRA $7AF2		; -> -$16(R0)

7B08	0044		RET R4

7B0A	3E47		MOVE $8E, R14
...
7B24	A061		BRA $7B88		; $62(R0)

7B26	A067		BRA $7B90		; $68(R0)

7B28	A06D		BRA $7B98		; $6E(R0)

7B2A	0000		HALT
7B2C	0000		HALT
7B2E	A083		BRA $7BB4		; $84(R0)

7B30	A089		BRA $7BBC		; $8A(R0)

7B32	A08F		BRA $7BC4		; $90(R0)

7B34	A095		BRA $7BCC		; $96(R0)

7B36	A09B		BRA $7BD4		; $9C(R0)

7B38	A0A1		BRA $7BDC		; $A2(R0)

7B3A	0000		HALT
7B3C	0000		HALT
7B3E	8110		LBI R1, #$10
7B40	C51E		SNBC R5, R1
7B42	A00B		BRA $7B50		; $0C(R0)

7B44	8101		LBI R1, #$01
7B46	C51E		SNBC R5, R1
7B48	A09B		BRA $7BE6		; $9C(R0)

7B4A	8180		LBI R1, #$80
7B4C	C516		SBC R5, R1
7B4E	A095		BRA $7BE6		; $96(R0)

7B50	1EFF		CTRL $E, #$FF
7B52	8110		LBI R1, #$10
7B54	C51E		SNBC R5, R1
7B56	A047		BRA $7BA0		; $48(R0)

7B58	8102		LBI R1, #$02
7B5A	C516		SBC R5, R1
7B5C	A04D		BRA $7BAC		; $4E(R0)

7B5E	A02F		BRA $7B90		; $30(R0)
...
7B76	8115		LBI R1, #$15
7B78	C512		SE R5, R1
7B7A	A003		BRA $7B80		; $04(R0)

7B7C	2550		MOVE R5, $A0
7B7E	A061		BRA $7BE2		; $62(R0)
...
7C7C	1EF3		CTRL $E, #$F3
7C7E	0E5E		GETB R5, $E
7C80	F0A5		BRA $7BDC		; -> -$A6(R0)

7C82	0EEE		GETB R14, $E
7C84	3601		MOVE $02, R6
7C86	3505		MOVE $0A, R5
7C88	214E		MOVE R1, $9C
7C8A	3100		MOVE $00, R1
7C8C	1EFF		CTRL $E, #$FF
7C8E	0000		HALT
7C90	0000		HALT
7C92	0000		HALT
...
7EFC	0000		HALT
7EFE	0000		HALT
7F00	216C		MOVE R1, $D8
7F02	A13B		ADD R1, #$3C
7F04	D718		MOVE R7, (R1)
7F06	0F33		INC2 R15, R3
7F08	6EF0		MOVB R14, (R15)+
7F0A	6DF6		MOVB R13, (R15)---
7F0C	CE0B		SNZ R14
7F0E	A00B		BRA $7F1C		; $0C(R0)

7F10	8C30		LBI R12, #$30
7F12	8103		LBI R1, #$03
7F14	CE10		SLE R14, R1
7F16	A007		BRA $7F20		; $08(R0)

7F18	CDC6		SBC R13, R12
7F1A	A02B		BRA $7F48		; $2C(R0)

7F1C	2807		MOVE R8, $0E
7F1E	2056		JMP ($00AC)

7F20	81FD		LBI R1, #$FD
7F22	CE12		SE R14, R1
7F24	F009		BRA $7F1C		; -> -$0A(R0)

7F26	CDC6		SBC R13, R12
7F28	A00D		BRA $7F38		; $0E(R0)

7F2A	8CF0		LBI R12, #$F0
7F2C	0CCD		MLH R12, R12
7F2E	8CF2		LBI R12, #$F2
7F30	AF0B		ADD R15, #$0C
7F32	5CF8		MOVE (R15), R12
7F34	0824		MOVE R8, R2
7F36	2056		JMP ($00AC)

7F38	8A00		LBI R10, #$00
7F3A	8110		LBI R1, #$10
7F3C	CD15		SBS R13, R1
7F3E	8AFF		LBI R10, #$FF
7F40	0803		INC2 R8, R0
7F42	A04F		BRA $7F94		; $50(R0)

7F44	0824		MOVE R8, R2
7F46	2056		JMP ($00AC)

7F48	8101		LBI R1, #$01
7F4A	CE18		SGT R14, R1
7F4C	A00B		BRA $7F5A		; $0C(R0)
...
7F58	A039		BRA $7F94		; $3A(R0)

7F5A	326A		MOVE $D4, R2
7F5C	2807		MOVE R8, $0E
7F5E	0203		INC2 R2, R0
7F60	2056		JMP ($00AC)

7F62	226A		MOVE R2, $D4
7F64	0F33		INC2 R15, R3
7F66	6EF0		MOVB R14, (R15)+
7F68	6DF6		MOVB R13, (R15)---
7F6A	8AFF		LBI R10, #$FF
7F6C	8120		LBI R1, #$20
7F6E	CD15		SBS R13, R1
7F70	8A00		LBI R10, #$00
7F72	8101		LBI R1, #$01
7F74	CE1A		SNE R14, R1
7F76	A013		BRA $7F8C		; $14(R0)

7F78	AF0B		ADD R15, #$0C
7F7A	DCF8		MOVE R12, (R15)
7F7C	CC03		SZ R12
7F7E	A003		BRA $7F84		; $04(R0)

7F80	0824		MOVE R8, R2
7F82	2056		JMP ($00AC)
...
7F98	DEF1		MOVE R14, (R15)+
7F9A	DDF8		MOVE R13, (R15)
7F9C	8F0B		LBI R15, #$0B
7F9E	0FFD		MLH R15, R15
7FA0	8FF2		LBI R15, #$F2
7FA2	2C50		MOVE R12, $A0
7FA4	8C1E		LBI R12, #$1E
7FA6	1102		CTRL $1, #$02
7FA8	41C0		PUTB $1, (R12)+
7FAA	41C4		PUTB $1, (R12)-
7FAC	F000		BRA $7FAD		; -> -$01(R0)

7FAE	01BE		GETB R11, $1
7FB0	0BBD		MLH R11, R11
7FB2	0004		NOP
7FB4	01BE		GETB R11, $1
7FB6	0FB4		MOVE R15, R11
7FB8	69E8		MOVB R9, (R14)
7FBA	0F98		ADD R15, R9
7FBC	41C0		PUTB $1, (R12)+
7FBE	41C4		PUTB $1, (R12)-
7FC0	F000		BRA $7FC1		; -> -$01(R0)

7FC2	019E		GETB R9, $1
7FC4	0004		NOP
7FC6	CA03		SZ R10
7FC8	019E		GETB R9, $1
7FCA	79E0		MOVB (R14)+, R9
7FCC	FD00		SUB R13, #$01
7FCE	01DC		MHL R1, R13
7FD0	01D6		OR R1, R13
7FD2	C103		SZ R1
7FD4	F01F		BRA $7FB6		; -> -$20(R0)
...
7FE0	011D		MLH R1, R1
7FE2	8104		LBI R1, #$04
7FE4	31E3		MOVE $1C6, R1
7FE6	817F		LBI R1, #$7F
7FE8	011D		MLH R1, R1
7FEA	8100		LBI R1, #$00
7FEC	246C		MOVE R4, $D8
7FEE	A437		ADD R4, #$38
7FF0	5143		MOVE (R4)++, R1
7FF2	8160		LBI R1, #$60
7FF4	011D		MLH R1, R1
7FF6	8100		LBI R1, #$00
7FF8	5148		MOVE (R4), R1
7FFA	0824		MOVE R8, R2
7FFC	2056		JMP ($00AC)

7FFE	F021		BRA $7FDE		; -> -$22(R0)
