...
IBM5110		equ	1		; 0 for IBM 5100, 1 for IBM 5110/5120
...
; ******************************
 ...
 ifdef IBM5110
EXIT:	JMP START		; TODO: implement return to interpreter
 endif
...
-	MOVE R13, (R3)+
 ...
 ifdef IBM5110
	; Level 3 ISR in RWS
	CTRL 4, #$03		; disable level 3
	MOVE R7, $A4
	SET R7, #$10
	MOVE $A4, R7
	LWI R3, #R7L0+1		; Lo(R7L0)
	PUTB 0, (R3)

	LWI R2, #KBD_INT	; address of kbd int routine
	MOVE R0L3, R2		; set new kbd int
	CTRL 4, #$00		; enable level 3
...
char_gun:	db $4B, $4B, $60, $7D, $7D, $7D, $60, $4B
		;   |    /    -    \    |    /    -    \

char_phaser:	db $FA, $61, $60, $B7, $FA, $61, $60, $B7
